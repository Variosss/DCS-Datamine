...
mount_vfs_texture_archives(LockOn_Options.script_path.."../Textures/A-10C-2019-CPT-TXT")
...
creators[devices.IFFCC]				= {"A10C::avIFFCC",
...
creators[devices.DSMS_INTERFACE]		= {"A10C::avDSMS_Interface",
...
creators[devices.MAVERICK_INTERFACE] = {"A10C::avMaverick_Interface",
...
creators[devices.DATA_TRANSFER_SYSTEM]	= {"A10C::avDataTransferSystem",
...
creators[devices.HOTAS]					= {"A10C::avHOTAS",
...
creators[devices.HUD]				= {"A10C::avHUD",
...
creators[devices.ACCELEROMETER] = {"A10Common::avAccelerometer",
...
indicators[#indicators + 1] = {"A10C::ccMFCD",			LockOn_Options.script_path.."MFCD/indicator/MFCD_left_init.lua"			,devices.MFCD_LEFT			,{{"PNT-MFCD-L-CENTER","PNT-MFCD-L-DOWN","PNT-MFCD-L-RIGHT"},{},tv_map_render_id[2]}}
indicators[#indicators + 1] = {"A10C::ccMFCD",			LockOn_Options.script_path.."MFCD/indicator/MFCD_right_init.lua"		,devices.MFCD_RIGHT			,{{"PNT-MFCD-R-CENTER","PNT-MFCD-R-DOWN","PNT-MFCD-R-RIGHT"},{},tv_map_render_id[3]}}
