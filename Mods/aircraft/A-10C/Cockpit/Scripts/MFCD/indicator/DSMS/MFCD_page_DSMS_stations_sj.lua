...
MavStat[3].controllers				= {{"DSMS_maverick_status", StoreIndexes[3]}, {"DSMS_launcher_sj_color", StoreIndexes[3],flash_time}}
...
MavStat[9].controllers				= {{"DSMS_maverick_status", StoreIndexes[9]}, {"DSMS_launcher_sj_color", StoreIndexes[9],flash_time}}
...
for i = 2, 10 do
	if i ~= 5 and i ~= 6 and i ~= 7 then
		add_rockets_param(i, "RocketParam" .. i, RocketParamStrFormats, {{"DSMS_station_is_rocket", StoreIndexes[i]}, {"DSMS_launcher_sj_color", StoreIndexes[i], flash_time}, {"DSMS_store_rocket_param", StoreIndexes[i]}})
	end
end
...
for i = 3, 9 do
	add_IAM_status(i, "IAM_status" .. i, IAM_str_formats, {{"DSMS_store_is_IAM", StoreIndexes[i]}, {"DSMS_store_IAM_status", StoreIndexes[i]}, {"DSMS_launcher_sj_color", StoreIndexes[i], flash_time}})
end
