...
InventorySettingsText.value				= "CBU-103"
...
Label_OSB17_type.controllers		= {{"DSMS_inventory_rpm", 0}}
...
add_osb_static_hint(17, _("CBU spin setting"))
