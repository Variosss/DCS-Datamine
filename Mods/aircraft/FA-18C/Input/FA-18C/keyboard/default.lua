...
{combos = {{key = 'L'}},								down = hotas_commands.THROTTLE_EXTERIOR_LIGHTS_EXT,																				cockpit_device_id = devices.HOTAS,	value_down =  1.0,					name = _('Exterior Lights Switch - ON/OFF'),				category = {_('Throttle Grip'), _('HOTAS')}},
...
{combos = {{key = '\\',	reformers = {'RAlt'}}},			down = hotas_commands.THROTTLE_COMMS_COMM1,						up = hotas_commands.THROTTLE_COMMS_COMM1,						cockpit_device_id = devices.HOTAS,	value_down =  0.2,	value_up = 0.0,	name = _('COMM Switch - COMM 1 (call radio menu)'),			category = {_('Throttle Grip'), _('HOTAS')}},
{combos = {{key = '\\',	reformers = {'RCtrl'}}},		down = hotas_commands.THROTTLE_COMMS_COMM2,						up = hotas_commands.THROTTLE_COMMS_COMM2,						cockpit_device_id = devices.HOTAS,	value_down =  0.4,	value_up = 0.0,	name = _('COMM Switch - COMM 2 (call radio menu)'),			category = {_('Throttle Grip'), _('HOTAS')}},

-- old cockpit commands
...
-- Master Caution
{combos = {{key = 'N'}},	down = cptlights_commands.MasterCaution,		up = cptlights_commands.MasterCaution,	cockpit_device_id = devices.CPT_LIGHTS,			value_down =  1.0,	value_up = 0.0,	name = _('MASTER CAUTION Reset Button'),												category = {_('Instrument Panel')}},
-- IR Cooling
...
{combos = {{key = 'S', reformers = {'LShift','LAlt'}}},		down = iCommandPilotGestureReadyToTaxi,																	name = _('Pilot Ready To Taxi'),	category = _('Communications')},
