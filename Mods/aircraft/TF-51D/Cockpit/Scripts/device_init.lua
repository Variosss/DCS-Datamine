...
creators[devices.DETROLA] = {"dcswwii::avBC1206", LockOn_Options.script_path .. "DetrolaReceiver/DetrolaReceiver.lua"}
creators[devices.IFF] = {"P51D::avIFF_SCR_695",
	LockOn_Options.script_path.."IFF_SCR_695/SCR_695_params.lua",
	{{"ElecInterface",devices.ELEC_INTERFACE}} }
creators[devices.HOMING_ADAPTER] = {"dcswwii::avAN_ARA8", LockOn_Options.script_path .. "HomingAdapter_AN_ARA8/AN_ARA8_params.lua"}
...
creators[devices.HEARING_SENS] = {"avBasicHearingSensitivityInterface", nil, {{"OXYGEN", devices.OXYGEN_SYSTEM}}}
