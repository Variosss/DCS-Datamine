...
-- Starboard Wall - Detrola Receiver ------------------------------------------------------
{                                                           action = device_commands.Button_6, cockpit_device_id = devices.DETROLA, name = _("Detrola Frequency Selector"), category = _("Detrola Receiver")},
{                                                           action = device_commands.Button_3, cockpit_device_id = devices.DETROLA, name = _("Detrola Volume"),             category = _("Detrola Receiver")},
-- ----------------------------------------------------------------------------------------
},
}
