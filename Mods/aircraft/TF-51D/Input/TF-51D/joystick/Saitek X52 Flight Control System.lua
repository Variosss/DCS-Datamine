...
{pressed = device_commands.Button_5, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = -1, name = _("Air Cold Decrease"), category = _("Environment System")},
{pressed = device_commands.Button_5, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = 1, name = _("Air Cold Increase"), category = _("Environment System")},
{pressed = device_commands.Button_6, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = -1, name = _("Air Hot Decrease"), category = _("Environment System")},
{pressed = device_commands.Button_6, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = 1, name = _("Air Hot Increase"), category = _("Environment System")},
{pressed = device_commands.Button_2, cockpit_device_id  = devices.ALTIMETER, value_pressed = -1, name = _("Altimeter pressure set Decrease"), category = _("Front Dash")},
{pressed = device_commands.Button_2, cockpit_device_id  = devices.ALTIMETER, value_pressed = 1, name = _("Altimeter pressure set Increase"), category = _("Front Dash")},
{down = iCommandPlaneEject, name = _("Bailout"), category = _("Systems")},
{down = device_commands.Button_2, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Battery"), category = _("Right Switch Panel")},
...
{down = device_commands.Button_5, cockpit_device_id  = devices.CPT_MECH, value_down = 1, name = _("Canopy Emergency Release"), category = _("Systems")},
...
{down = device_commands.Button_25, up = device_commands.Button_25, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, value_up = 0, name = _("Circuit Protectors Cover"), category = _("Right Switch Panel")},
{down = iCommandCockpitClickModeOnOff, name = _("Clickable mouse cockpit mode On/Off"), category = _("General")},
{down = device_commands.Button_3, cockpit_device_id  = devices.CLOCK, value_down = 1, name = _("Clock Winding/Adjust"), category = _("Front Dash")},
{pressed = device_commands.Button_4, cockpit_device_id  = devices.CLOCK, value_pressed = -1, name = _("Clock Winding/Adjust Decrease"), category = _("Front Dash")},
{pressed = device_commands.Button_4, cockpit_device_id  = devices.CLOCK, value_pressed = 1, name = _("Clock Winding/Adjust Increase"), category = _("Front Dash")},
...
{pressed = device_commands.Button_5, cockpit_device_id  = devices.LIGHT_SYSTEM, value_pressed = -1, name = _("Cockpit Fluorescent Light Left Decrease"), category = _("Environment System")},
{pressed = device_commands.Button_5, cockpit_device_id  = devices.LIGHT_SYSTEM, value_pressed = 1, name = _("Cockpit Fluorescent Light Left Increase"), category = _("Environment System")},
{pressed = device_commands.Button_10, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_pressed = -1, name = _("Cockpit Fluorescent Light Right Decrease"), category = _("Environment System")},
{pressed = device_commands.Button_10, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_pressed = 1, name = _("Cockpit Fluorescent Light Right Increase"), category = _("Environment System")},
{pressed = device_commands.Button_3, cockpit_device_id  = devices.FRONT_SWITCH_BOX, value_pressed = -1, name = _("Cockpit Lights Decrease"), category = _("Front Switch Box")},
{pressed = device_commands.Button_3, cockpit_device_id  = devices.FRONT_SWITCH_BOX, value_pressed = 1, name = _("Cockpit Lights Increase"), category = _("Front Switch Box")},
...
{pressed = device_commands.Button_8, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Cold Air Control to RAM"), category = _("Carburetor Air Controls")},
{pressed = device_commands.Button_8, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Cold Air Control to UNRAMMED FILTERED"), category = _("Carburetor Air Controls")},
{pressed = device_commands.Button_2, cockpit_device_id = 23, value_pressed = -1, name = _("Compass course Decrease"), category = _("Front Dash")},
{pressed = device_commands.Button_2, cockpit_device_id = 23, value_pressed = 1, name = _("Compass course Increase"), category = _("Front Dash")},
...
{pressed = device_commands.Button_4, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = -1, name = _("Defroster Decrease"), category = _("Environment System")},
{pressed = device_commands.Button_4, cockpit_device_id  = devices.ENVIRONMENT_SYSTEM, value_pressed = 1, name = _("Defroster Increase"), category = _("Environment System")},
{pressed = device_commands.Button_3, cockpit_device_id = devices.DETROLA, value_pressed = -1, name = _("Detrola Frequency Selector Decrease"), category = _("Detrola Receiver")},
{pressed = device_commands.Button_3, cockpit_device_id = devices.DETROLA, value_pressed = 1, name = _("Detrola Frequency Selector Increase"), category = _("Detrola Receiver")},
{pressed = device_commands.Button_4, cockpit_device_id = devices.DETROLA, value_pressed = -1, name = _("Detrola Volume Decrease"), category = _("Detrola Receiver")},
{pressed = device_commands.Button_4, cockpit_device_id = devices.DETROLA, value_pressed = 1, name = _("Detrola Volume Increase"), category = _("Detrola Receiver")},
...
{pressed = device_commands.Button_2, cockpit_device_id  = devices.DIRECTIONAL_GYRO, value_pressed = -1, name = _("Directional gyro heading Decrease"), category = _("Front Dash")},
{pressed = device_commands.Button_2, cockpit_device_id  = devices.DIRECTIONAL_GYRO, value_pressed = 1, name = _("Directional gyro heading Increase"), category = _("Front Dash")},
{pressed = device_commands.Button_24, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Engine RPM Decrease"), category = _("Flight Control")},
{pressed = device_commands.Button_24, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Engine RPM Increase"), category = _("Flight Control")},
...
{combos = {{key = "JOY_BTN22"}, }, down = device_commands.Button_2, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 0, name = _("Flaps Down"), category = _("Flight Control")},
{combos = {{key = "JOY_BTN20"}, }, down = device_commands.Button_2, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, name = _("Flaps Up"), category = _("Flight Control")},
...
{down = device_commands.Button_6, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, name = _("Fuel Booster"), category = _("Engine Control Panel")},
...
{down = device_commands.Button_1, cockpit_device_id  = devices.FUEL_SYSTEM, value_down = 0, name = _("Fuel selector Right Combat Tank"), category = _("Fuel Control")},
...
{down = device_commands.Button_6, cockpit_device_id  = devices.FUEL_SYSTEM, value_down = 1, name = _("Fuel selector valve (rotary)"), category = _("Fuel Control")},
{down = device_commands.Button_3, cockpit_device_id  = devices.FUEL_SYSTEM, value_down = 1, name = _("Fuel shut-off valve"), category = _("Fuel Control")},
{down = device_commands.Button_4, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Generator"), category = _("Right Switch Panel")},
{down = iCommandRecoverHuman, name = _("Get new plane - respawn"), category = _("General")},
{down = device_commands.Button_20, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Gun heat"), category = _("Right Switch Panel")},
{down = device_commands.Button_4, up = device_commands.Button_4, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, value_up = 0, name = _("High Blower lamp test"), category = _("Engine Control Panel")},
...
{down = device_commands.Button_4, cockpit_device_id  = devices.HOMING_ADAPTER, value_down = 1, name = _("Homing Adapter CW/MCW"), category = _("Homing Adapter")},
{down = device_commands.Button_3, up = device_commands.Button_3, cockpit_device_id  = devices.HOMING_ADAPTER, value_down = 1, value_up = 0, name = _("Homing Adapter Circuit Breaker"), category = _("Homing Adapter")},
...
{down = device_commands.Button_1, cockpit_device_id  = devices.HOMING_ADAPTER, value_down = 0, name = _("Homing Adapter TRANS"), category = _("Homing Adapter")},
{down = device_commands.Button_5, cockpit_device_id  = devices.ARTIFICIAL_HORIZON, value_down = 1, name = _("Horizon Cage"), category = _("Front Dash")},
{pressed = device_commands.Button_6, cockpit_device_id  = devices.ARTIFICIAL_HORIZON, value_pressed = -1, name = _("Horizon cage knob OFF"), category = _("Front Dash")},
{pressed = device_commands.Button_6, cockpit_device_id  = devices.ARTIFICIAL_HORIZON, value_pressed = 1, name = _("Horizon cage knob ON"), category = _("Front Dash")},
{pressed = device_commands.Button_4, cockpit_device_id  = devices.ARTIFICIAL_HORIZON, value_pressed = -1, name = _("Horizon pitch Decrease"), category = _("Front Dash")},
{pressed = device_commands.Button_4, cockpit_device_id  = devices.ARTIFICIAL_HORIZON, value_pressed = 1, name = _("Horizon pitch Increase"), category = _("Front Dash")},
...
{down = device_commands.Button_2, cockpit_device_id  = devices.HYDRAULIC_SYSTEM, value_down = 1, name = _("Hydraulic Emergency Release Knob"), category = _("Systems")},
...
{down = device_commands.Button_13, cockpit_device_id  = devices.IFF, value_down = 1, name = _("IFF Detonator Circuit On/Off"), category = _("IFF")},
{down = device_commands.Button_7, up = device_commands.Button_7, cockpit_device_id  = devices.IFF, value_down = 1, value_up = 0, name = _("IFF Detonator Left"), category = _("IFF")},
{down = device_commands.Button_8, up = device_commands.Button_8, cockpit_device_id  = devices.IFF, value_down = 1, value_up = 0, name = _("IFF Detonator Right"), category = _("IFF")},
...
{down = device_commands.Button_9, cockpit_device_id  = devices.IFF, value_down = 1, name = _("IFF Power On/Off"), category = _("IFF")},
...
{down = device_commands.Button_2, cockpit_device_id  = devices.FRONT_SWITCH_BOX, value_down = 0, name = _("Ignition switch OFF"), category = _("Front Switch Box")},
...
{down = device_commands.Button_1, cockpit_device_id  = devices.KNEEBOARD, value_down = 1, name = _("Kneeboard Next Page"), category = _("Kneeboard")},
{down = iCommandPlaneShowKneeboard, name = _("Kneeboard ON/OFF"), category = _("Kneeboard")},
{down = device_commands.Button_2, cockpit_device_id  = devices.KNEEBOARD, value_down = 1, name = _("Kneeboard Previous Page"), category = _("Kneeboard")},
{down = device_commands.Button_3, cockpit_device_id  = devices.KNEEBOARD, value_down = 1, name = _("Kneeboard current position mark point"), category = _("Kneeboard")},
...
{down = device_commands.Button_18, up = device_commands.Button_18, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, value_up = 0, name = _("Landing Gear Safe Light Test"), category = _("Systems")},
{down = device_commands.Button_7, up = device_commands.Button_7, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, value_up = 0, name = _("Landing Gear Unsafe Light Test"), category = _("Systems")},
{combos = {{key = "JOY_BTN14"}, }, down = device_commands.Button_4, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, name = _("Landing Gear Up/Down"), category = _("Systems")},
{down = device_commands.Button_4, cockpit_device_id  = devices.LIGHT_SYSTEM, value_down = 1, name = _("Landing Light"), category = _("Environment System")},
{down = iCommandViewLeftMirrorOn, up = iCommandViewLeftMirrorOff, name = _("Mirror glance"), category = _("View Cockpit")},
{combos = {{key = "JOY_BTN32"}, }, down = device_commands.Button_11, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.2, name = _("Mixture EMERGENCY FULL RICH"), category = _("Flight Control")},
{combos = {{key = "JOY_BTN34"}, }, down = device_commands.Button_11, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0, name = _("Mixture IDLE CUT OFF"), category = _("Flight Control")},
{combos = {{key = "JOY_BTN33"}, }, down = device_commands.Button_11, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.1, name = _("Mixture RUN"), category = _("Flight Control")},
{down = device_commands.Button_20, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 1, name = _("Mixture control (rotary)"), category = _("Flight Control")},
...
{down = device_commands.Button_7, up = device_commands.Button_7, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, value_up = 0, name = _("Oil Dilute"), category = _("Engine Control Panel")},
{down = iCommandOneFrame, name = _("One frame mode"), category = _("General")},
{down = device_commands.Button_2, cockpit_device_id  = devices.OXYGEN_SYSTEM, value_down = 1, name = _("Oxygen regulator Deluter lever Auto-Mix On-Off"), category = _("Systems")},
{down = device_commands.Button_4, cockpit_device_id  = devices.OXYGEN_SYSTEM, value_down = 1, name = _("Oxygen regulator Emergency By-Pass Valve"), category = _("Systems")},
{combos = {{key = "JOY_BTN30"}, }, down = iCommandPlane_P_51_PTT_on, up = iCommandPlane_P_51_PTT_off, name = _("COMM Push to talk"), category = _("Communications")},
...
{down = device_commands.Button_6, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Pitot heat"), category = _("Right Switch Panel")},
{down = iCommandTrkEsc, name = _("Playback track cancel"), category = _("General")},
{down = device_commands.Button_18, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Position light tail (rotary)"), category = _("Right Switch Panel")},
{down = device_commands.Button_9, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Position light tail BRIGHT"), category = _("Right Switch Panel")},
{down = device_commands.Button_9, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = -1, name = _("Position light tail DIM"), category = _("Right Switch Panel")},
{down = device_commands.Button_9, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 0, name = _("Position light tail OFF"), category = _("Right Switch Panel")},
{down = device_commands.Button_17, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Position lights wing (rotary)"), category = _("Right Switch Panel")},
{down = device_commands.Button_8, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Position lights wing BRIGHT"), category = _("Right Switch Panel")},
{down = device_commands.Button_8, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = -1, name = _("Position lights wing DIM"), category = _("Right Switch Panel")},
{down = device_commands.Button_8, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 0, name = _("Position lights wing OFF"), category = _("Right Switch Panel")},
{down = device_commands.Button_11, up = device_commands.Button_11, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, value_up = 0, name = _("Primer"), category = _("Engine Control Panel")},
{pressed = device_commands.Button_15, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Propeller & Mixture Lock"), category = _("Flight Control")},
{pressed = device_commands.Button_15, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Propeller & Mixture Unlock"), category = _("Flight Control")},
...
{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.1, value_up = 0, name = _("Radiator coolant Close"), category = _("Radiator Air Controls")},
{down = device_commands.Button_5, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 1, name = _("Radiator coolant Cover"), category = _("Radiator Air Controls")},
{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.3, value_up = 0, name = _("Radiator coolant Open"), category = _("Radiator Air Controls")},
...
{down = device_commands.Button_2, up = device_commands.Button_2, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.1, value_up = 0, name = _("Radiator oil Close"), category = _("Radiator Air Controls")},
{down = device_commands.Button_6, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 1, name = _("Radiator oil Cover"), category = _("Radiator Air Controls")},
{down = device_commands.Button_2, up = device_commands.Button_2, cockpit_device_id  = devices.ENGINE_SYSTEM, value_down = 0.3, value_up = 0, name = _("Radiator oil Open"), category = _("Radiator Air Controls")},
{down = device_commands.Button_8, up = device_commands.Button_8, cockpit_device_id  = devices.VHF_RADIO, value_down = -1, value_up = 0, name = _("Radio Mode T"), category = _("VHF Radio")},
{down = device_commands.Button_9, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio Power"), category = _("VHF Radio")},
{down = device_commands.Button_10, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio chanel A"), category = _("VHF Radio")},
{down = device_commands.Button_11, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio chanel B"), category = _("VHF Radio")},
{down = device_commands.Button_12, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio chanel C"), category = _("VHF Radio")},
{down = device_commands.Button_13, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio chanel D"), category = _("VHF Radio")},
{pressed = device_commands.Button_14, cockpit_device_id  = devices.VHF_RADIO, value_pressed = -1, name = _("Radio lights dimmer Decrease"), category = _("VHF Radio")},
{pressed = device_commands.Button_14, cockpit_device_id  = devices.VHF_RADIO, value_pressed = 1, name = _("Radio lights dimmer Increase"), category = _("VHF Radio")},
{down = device_commands.Button_7, cockpit_device_id  = devices.VHF_RADIO, value_down = 0, name = _("Radio mode R"), category = _("VHF Radio")},
{down = device_commands.Button_7, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio mode REM"), category = _("VHF Radio")},
{down = device_commands.Button_18, cockpit_device_id  = devices.VHF_RADIO, value_down = 1, name = _("Radio mode switch locking lever"), category = _("VHF Radio")},
{down = device_commands.Button_2, cockpit_device_id  = devices.TAIL_WARNING_RADAR, value_down = 1, name = _("Rear warning radar Power"), category = _("Rear Warning Radar")},
{down = device_commands.Button_3, up = device_commands.Button_3, cockpit_device_id  = devices.TAIL_WARNING_RADAR, value_down = 1, value_up = 0, name = _("Rear warning radar Test"), category = _("Rear Warning Radar")},
{pressed = device_commands.Button_5, cockpit_device_id  = devices.TAIL_WARNING_RADAR, value_pressed = -1, name = _("Rear warning radar signal light Decrease"), category = _("Rear Warning Radar")},
{pressed = device_commands.Button_5, cockpit_device_id  = devices.TAIL_WARNING_RADAR, value_pressed = 1, name = _("Rear warning radar signal light Increase"), category = _("Rear Warning Radar")},
{down = iCommandMissionResourcesManagement, name = _("Rearming and Refueling Window"), category = _("General")},
{down = device_commands.Button_32, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light amber (rotary)"), category = _("Right Switch Panel")},
{down = device_commands.Button_23, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = -1, name = _("Recognition light amber Key"), category = _("Right Switch Panel")},
{down = device_commands.Button_23, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 0, name = _("Recognition light amber Off"), category = _("Right Switch Panel")},
{down = device_commands.Button_23, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light amber Steady"), category = _("Right Switch Panel")},
{down = device_commands.Button_31, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light green (rotary)"), category = _("Right Switch Panel")},
{down = device_commands.Button_22, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = -1, name = _("Recognition light green Key"), category = _("Right Switch Panel")},
{down = device_commands.Button_22, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 0, name = _("Recognition light green Off"), category = _("Right Switch Panel")},
{down = device_commands.Button_22, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light green Steady"), category = _("Right Switch Panel")},
{down = device_commands.Button_30, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light red (rotary)"), category = _("Right Switch Panel")},
{down = device_commands.Button_21, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = -1, name = _("Recognition light red Key"), category = _("Right Switch Panel")},
{down = device_commands.Button_21, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 0, name = _("Recognition light red Off"), category = _("Right Switch Panel")},
{down = device_commands.Button_21, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, name = _("Recognition light red Steady"), category = _("Right Switch Panel")},
{down = device_commands.Button_24, up = device_commands.Button_24, cockpit_device_id  = devices.RIGHT_SWITCH_PANEL, value_down = 1, value_up = 0, name = _("Recognition lights key"), category = _("Right Switch Panel")},
...
{down = device_commands.Button_8, up = device_commands.Button_8, cockpit_device_id  = devices.FRONT_SWITCH_BOX, value_down = 1, value_up = 0, name = _("Silence Horn"), category = _("Front Switch Box")},
...
{down = device_commands.Button_8, up = device_commands.Button_8, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, value_up = 0, name = _("Starter"), category = _("Engine Control Panel")},
{down = device_commands.Button_10, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, name = _("Starter Switch Cover"), category = _("Engine Control Panel")},
{down = device_commands.Button_15, up = device_commands.Button_15, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, value_up = 0, name = _("Stick lock in the Forward Position"), category = _("Flight Control")},
{down = device_commands.Button_16, up = device_commands.Button_16, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, value_up = 0, name = _("Stick lock in the Neutral Position"), category = _("Flight Control")},
{down = iCommandEnginesStop, name = _("Stop Procedure"), category = _("Cheat")},
{down = device_commands.Button_1, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 0, name = _("Supercharger switch AUTO"), category = _("Engine Control Panel")},
{down = device_commands.Button_3, cockpit_device_id  = devices.ENGINE_CONTROL_PANEL, value_down = 1, name = _("Supercharger switch Cover"), category = _("Engine Control Panel")},
...
{pressed = device_commands.Button_13, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Throttle Control Lock"), category = _("Flight Control")},
{pressed = device_commands.Button_13, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Throttle Control Unlock"), category = _("Flight Control")},
{pressed = device_commands.Button_23, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Throttle Down"), category = _("Flight Control")},
{pressed = device_commands.Button_23, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Throttle Up"), category = _("Flight Control")},
...
{down = device_commands.Button_14, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, name = _("Trimmers Reset"), category = _("Flight Control")},
{pressed = device_commands.Button_16, cockpit_device_id  = devices.VHF_RADIO, value_pressed = -1, name = _("VHF radio volume Decrease"), category = _("VHF Radio")},
{pressed = device_commands.Button_16, cockpit_device_id  = devices.VHF_RADIO, value_pressed = 1, name = _("VHF radio volume Increase"), category = _("VHF Radio")},
...
{pressed = device_commands.Button_28, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = -1, name = _("Warm Air Control to HOT"), category = _("Carburetor Air Controls")},
{pressed = device_commands.Button_28, cockpit_device_id  = devices.ENGINE_SYSTEM, value_pressed = 1, name = _("Warm Air Control to NORMAL"), category = _("Carburetor Air Controls")},
{down = iCommandPlaneWheelBrakeOn, up = iCommandPlaneWheelBrakeOff, name = _("Wheel brake Both"), category = _("Systems")},
{combos = {{key = "JOY_BTN23"}, }, down = iCommandPlaneWheelBrakeLeftOn, up = iCommandPlaneWheelBrakeLeftOff, name = _("Wheel brake Left"), category = _("Systems")},
{down = device_commands.Button_6, up = device_commands.Button_6, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1, value_up = 0, name = _("Wheel brake Parking"), category = _("Systems")},
{combos = {{key = "JOY_BTN21"}, }, down = iCommandPlaneWheelBrakeRightOn, up = iCommandPlaneWheelBrakeRightOff, name = _("Wheel brake Right"), category = _("Systems")},
...
{combos = {{key = "JOY_BTN26"}, }, pressed = iCommandViewForwardSlow, up = iCommandViewForwardSlowStop, name = _("Zoom in slow"), category = _("View")},
...
{combos = {{key = "JOY_BTN24"}, }, pressed = iCommandViewBackSlow, up = iCommandViewBackSlowStop, name = _("Zoom out slow"), category = _("View")},
},
axisCommands = {
...
{combos = {{key = "JOY_RX", filter = {saturationX = 1, saturationY = 1, deadzone = 0, invert = true, slider = false, curvature = {0}}}, }, action = device_commands.Button_26, cockpit_device_id  = devices.ENGINE_SYSTEM, name = _("Engine RPM Setting")},
...
{combos = {{key = "JOY_Z"}, }, action = device_commands.Button_25, cockpit_device_id  = devices.ENGINE_SYSTEM, name = _("Throttle")},
