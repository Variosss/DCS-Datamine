...
function create_threat(num)
	...
	local threat_str           = CreateElement "ceStringPoly"
		...
		threat_str.controllers = {{"RWR_threat_string",num},{"RWR_brightness_RIO"}}
	...
	local threat_naval = my_create_textured_box_1k(470,872,228,148,nil,nil,0.200*size)
        ...
        threat_naval.controllers = {{"RWR_threat_naval",num},{"RWR_brightness_RIO"}}
...
local category_str           = CreateElement "ceStringPoly"
	...
	category_str.controllers = {{"RWR_category_string"},{"RWR_brightness_RIO"}}
...
local mode_str           = CreateElement "ceStringPoly"
	...
	mode_str.controllers = {{"RWR_mode_string"},{"RWR_brightness_RIO"}}
...
local bit_str           = CreateElement "ceStringPoly"
	...
	bit_str.controllers = {{"RWR_system_status_string"},{"RWR_brightness_RIO"}}
