...
local bit_str           = CreateElement "ceStringPoly"
	...
	bit_str.controllers = {{"RWR_bit_string"},{"RWR_brightness_RIO"}}
...
local bit_str2           = CreateElement "ceStringPoly"
	...
	bit_str2.controllers = {{"RWR_bit_string2"},{"RWR_brightness_RIO"}}
	bit_str2.value 			= "\n\n .     . "
...
local bit_str3           = CreateElement "ceStringPoly"
	...
	bit_str3.controllers = {{"RWR_bit_string2"},{"RWR_brightness_RIO"}}
	bit_str3.value 			= "\n\n    :  : "
