...
local bit_failure_v_str           = CreateElement "ceStringPoly"
	...
	bit_failure_v_str.controllers = {{"RWR_bit_string"},{"RWR_brightness_pilot"}}
...
local bit_lib_ver_str           = CreateElement "ceStringPoly"
	...
	bit_lib_ver_str.controllers = {{"RWR_bit_library_ver"},{"RWR_brightness_pilot"}}
...
local bit_software_ver_str           = CreateElement "ceStringPoly"
	...
	bit_software_ver_str.controllers = {{"RWR_brightness_pilot"}}
...
local bit_config_str           = CreateElement "ceStringPoly"
	...
	bit_config_str.controllers = {{"RWR_brightness_pilot"}}
...
local bit_receiver_mode           = CreateElement "ceStringPoly"
	...
	bit_receiver_mode.controllers = {{"RWR_brightness_pilot"}}
...
local bit_status_45           = CreateElement "ceStringPoly"
	...
	bit_status_45.controllers = {{"RWR_bit_rcvr_flag",0},{"RWR_brightness_pilot"}}
...
local bit_status_135           = CreateElement "ceStringPoly"
	...
	bit_status_135.controllers = {{"RWR_bit_rcvr_flag",1},{"RWR_brightness_pilot"}}
...
local bit_status_225           = CreateElement "ceStringPoly"
	...
	bit_status_225.controllers = {{"RWR_bit_rcvr_flag",2},{"RWR_brightness_pilot"}}
...
local bit_status_315           = CreateElement "ceStringPoly"
	...
	bit_status_315.controllers = {{"RWR_bit_rcvr_flag",3},{"RWR_brightness_pilot"}}
