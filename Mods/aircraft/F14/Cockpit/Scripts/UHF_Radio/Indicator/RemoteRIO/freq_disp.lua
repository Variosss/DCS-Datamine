dofile(LockOn_Options.script_path.."Scripts/UHF_Radio/Indicator/RemoteRIO/tools.lua")
...
local freq_string               = CreateElement "ceStringPoly"
    ...
    freq_string.controllers 	= {{"arc159freq_bright_remote_RIO"},{"arc159freq_str_remote_RIO",0}}
...
local freq_dot_string               = CreateElement "ceStringPoly"
    ...
    freq_dot_string.controllers 	= {{"arc159freq_bright_remote_RIO"},{"arc159dot_visible_RIO"}}
