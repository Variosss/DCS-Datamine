dofile(LockOn_Options.script_path.."Scripts/VHF_Radio/Indicator/RemotePilot/tools.lua")
...
local freq_string               = CreateElement "ceStringPoly"
    ...
    freq_string.controllers 	= {{"arc182freq_bright_remote_pilot"},{"arc182freq_str_remote_pilot",0}}
...
local freq_dot_string               = CreateElement "ceStringPoly"
    ...
    freq_dot_string.controllers 	= {{"arc182freq_bright_remote_pilot"},{"arc182dot_visible_pilot"}}
