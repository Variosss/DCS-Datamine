...
local vhf_page_path = LockOn_Options.script_path.."Scripts/VHF_Radio/Indicator/RemotePilot/"
...
page_subsets = {
	[id_pagesubset.VHF_FREQ_OFF] = vhf_page_path.."base_page.lua",
	[id_pagesubset.VHF_FREQ_ON]  = vhf_page_path.."freq_disp.lua",
}

pages = {
    {id_pagesubset.VHF_FREQ_OFF, id_pagesubset.VHF_FREQ_ON},
}
...
--
try_find_assigned_viewport("F14_VHF_ARC182")
