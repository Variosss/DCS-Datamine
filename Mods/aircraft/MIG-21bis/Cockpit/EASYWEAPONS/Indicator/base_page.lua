dofile(LockOn_Options.script_path.."EASYWEAPONS/Indicator/definitions.lua")

local TST   = MakeMaterial(nil,{255,0,0,255}) 
...
total_field_of_view.level			= WEAPONSINFO_DEFAULT_LEVEL
