...
{	down = gear_commands.AltGearHandle,											cockpit_device_id = devices.GEAR_INTERFACE,		value_down =  1.0,					name = _('ALT GEAR Handle, PULL'),					category = {_('Left Auxiliary Console')}},
{	down = gear_commands.AltGearHandle,											cockpit_device_id = devices.GEAR_INTERFACE,		value_down =  0.0,					name = _('ALT GEAR Handle, STOW'),					category = {_('Left Auxiliary Console')}},
{	down = gear_commands.AltGearHandle_ITER,									cockpit_device_id = devices.GEAR_INTERFACE,		value_down =  1.0,					name = _('ALT GEAR Handle, PULL/STOW'),				category = {_('Left Auxiliary Console')}},
{	down = gear_commands.AltGearResetBtn,										cockpit_device_id = devices.GEAR_INTERFACE,		value_down =  1.0,					name = _('ALT GEAR Handle, RESET'),					category = {_('Left Auxiliary Console')}},
