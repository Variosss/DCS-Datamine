...
-- Spinup rate
SpinUpT = 36 -- time constant, spinup time - ~3 minutes
-- Slowdown rate
SlowDownT = 100 -- time constant, slow down time - ~9 minutes
...
pitch = {isLagElement = true, valmin = -math.rad(78.0), valmax = math.rad(92.0), T1 = 0.1, wmax = math.rad(80.0), bias = {{valmin = -math.rad(90.0), valmax = math.rad(90.0), bias = math.rad(0.3)}}}
...
--
GyroElectConsumerParams = {20.0, true, 20.2, 21.5, 28.0}
