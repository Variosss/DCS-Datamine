...
function addStrokeMultiLine(name, vertsNum, pos, parent, controllers, cycled, material)
	local verts	= {}
	local indices = {}
--{0, 1, 1, 2, 2, 3, 3, 0}
	for i = 0, vertsNum-1 do
		verts[i+1] = {0, 0}
		if i ~= vertsNum-1 then
			indices[#indices + 1] = i
...
function addStrokeBox(name, sideX, sideY, align, pos, parent, controllers, material, thickness)
	...
	box.thickness	= thickness or stroke_thickness
