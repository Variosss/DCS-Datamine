...
{down = devCmds.Cmd556, cockpit_device_id = devices.MAIN, value_down = 1.0, name = _('Mode selector switch - RIGHT'), category = {_('Central front panel'), _('Navigation indicator')}},
{down = devCmds.Cmd556, cockpit_device_id = devices.MAIN, value_down = -1.0, name = _('Mode selector switch - LEFT'), category = {_('Central front panel'), _('Navigation indicator')}},
-- Normal/Additional vector selector switch
{down = devCmds.Cmd557, cockpit_device_id = devices.MAIN, value_down = 1.0, name = _('Normal/Additional vector selector switch - VECT. ADD.'), category = {_('Central front panel'), _('Navigation indicator')}},
{down = devCmds.Cmd557, cockpit_device_id = devices.MAIN, value_down = 0.0, name = _('Normal/Additional vector selector switch - NORMAL'), category = {_('Central front panel'), _('Navigation indicator')}},
-- Additional target selector switch
{down = devCmds.Cmd558, cockpit_device_id  = devices.MAIN, value_down = 1.0, name = _('Additional target selector switch - Clockwise'), category = {_('Central front panel'), _('Navigation indicator')}},
{down = devCmds.Cmd558, cockpit_device_id  = devices.MAIN, value_down = -1.0, name = _('Additional target selector switch - Counterclockwise'), category = {_('Central front panel'), _('Navigation indicator')}},
-- Bearing/Distance selector knob
{pressed = devCmds.Cmd559, cockpit_device_id  = devices.MAIN, value_pressed = 1.0, name = _('Bearing/Distance selector knob - Clockwise'), category = {_('Central front panel'), _('Navigation indicator')}},
{pressed = devCmds.Cmd559, cockpit_device_id  = devices.MAIN, value_pressed = -1.0, name = _('Bearing/Distance selector knob - Counterclockwise'), category = {_('Central front panel'), _('Navigation indicator')}},
-- Test button
{down = devCmds.Cmd560, up = devCmds.Cmd560, cockpit_device_id = devices.MAIN ,value_down = 1.0, value_up = 0.0, name = _('Test button'), category = {_('Central front panel'), _('Navigation indicator')}},

----------------------------------------------------------------
-- MATRA 550 or Sidewinder jettisoning

-- MATRA 550 or Sidewinder jettison button guard
{down = devCmds.Cmd561, cockpit_device_id = devices.MAIN, value_down = 1.1, name = _('MATRA 550 or Sidewinder jettison button guard - OPEN'), category = {_('Central front panel'), _('Armament system')}},
{down = devCmds.Cmd561, cockpit_device_id = devices.MAIN, value_down = -0.1, name = _('MATRA 550 or Sidewinder jettison button guard - CLOSE'), category = {_('Central front panel'), _('Armament system')}},
-- MATRA 550 or Sidewinder jettison button
{down = devCmds.Cmd562, up = devCmds.Cmd562, cockpit_device_id = devices.MAIN ,value_down = 1.0, value_up = 0.0, name = _('MATRA 550 or Sidewinder jettison button'), category = {_('Central front panel'), _('Armament system')}},

----------------------------------------------------------------
-- Radar detector indicator

-- Indicator lights intensity adjusting switch and lights 'T' test button
{down = devCmds.Cmd573, up = devCmds.Cmd573, cockpit_device_id = devices.MAIN ,value_down = 1.0, value_up = 0.0, name = _('Indicator lights T test button'), category = {_('Central front panel'), _('Radar detector')}},
...
{down = devCmds.Cmd291, up = devCmds.Cmd291, cockpit_device_id = devices.MAIN ,value_down = 1.0, value_up = 0.0, name = _('Jammer detection light - PUSH'), category = {_('Central front panel'), _('Warnings')}},
{pressed = devCmds.Cmd293, cockpit_device_id  = devices.MAIN, value_pressed = 1.0, name = _('Jammer detection light - Increase'), category = {_('Central front panel'), _('Warnings')}},
{pressed = devCmds.Cmd293, cockpit_device_id  = devices.MAIN, value_pressed = -1.0, name = _('Jammer detection light - Decrease'), category = {_('Central front panel'), _('Warnings')}},
