local defaultPosXY = {x_trans = -0.02, y_trans = 0.003}
...
local playerSnapViews = {
		[1]  = head_pos_default(defaultPosXY),--Num 0
		[2]  = head_pos_default({
		...
		[6]  = head_pos_default(defaultPosXY),--LWin + Num5 : Snap View 5 - Default view
		[7]  = head_pos_default({
		...
		[13] = head_pos_default(defaultPosXY)--default view
}
