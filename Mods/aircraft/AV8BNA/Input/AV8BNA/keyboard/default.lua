...
join(res.keyCommands,{
	...
	-- HUD Controls
	{combos = {{key = 'Num1', reformers = {'LCtrl', 'LWin'}}},	down = iCommandPlane_ABRIS_BT_1,	name = _('HUD Reject Switch Down (NORM - REJ1 - REJ2)'),		category = _('HUD Control')},
	{combos = {{key = 'Num2', reformers = {'LCtrl', 'LWin'}}},	down = iCommandPlane_ABRIS_BT_2,	name = _('HUD Reject Switch Up (REJ2 - REJ1 - NORM)'),			category = _('HUD Control')},
	...
	{combos = {{key = 'Num5', reformers = {'LCtrl', 'LWin'}}},	down = iCommandPlane_ABRIS_BT_4,	name = _('HUD Altitude Selector'),								category = _('HUD Control')},
	...
	{combos = {{key = 'P',	reformers = {'RWin'}}},	down = iCommandPlaneSAUHRadio,		name = _('Stability Augmentation - Pitch Toggle'),					category = _('Stability Augmentation & Autopilot')},
	{combos = {{key = 'Y',	reformers = {'RWin'}}},	down = iCommandPlaneSAUAutomatic,	name = _('Stability Augmentation - Yaw Toggle'),					category = _('Stability Augmentation & Autopilot')},
	...
	{combos = {{key = 'P',	reformers = {'RShift'}}},			down = iCommandCockpitShowPilotOnOff,													name = _('Hide/Show Pilot Body'),							category = _('Pilot & Seat Controls')},
	{combos = {{key = 'S',	reformers = {'RCtrl', 'RWin'}}},	down = iCommandPlaneCircuitBreaker_10,													name = _('Hide/Show Stick and Throttle'),					category = _('Pilot & Seat Controls')},	
	...
	{combos = {{key = 'U', reformers = {'LAlt'}}},		down = hotas_commands.SSS_FWD,						up = hotas_commands.SSS_FWD,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select FWD: INS, IRMV/EOMV'),  		category = _('HOTAS')},
	{combos = {{key = 'J', reformers = {'LAlt'}}},		down = hotas_commands.SSS_AFT,						up = hotas_commands.SSS_AFT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select AFT: DMT: LST/TV'),  			category = _('HOTAS')},
	{combos = {{key = 'Y', reformers = {'LShift'}}},	down = hotas_commands.SSS_LEFT,						up = hotas_commands.SSS_LEFT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select LEFT: MAP Center/Decenter'),	category = _('HOTAS')},
	{combos = {{key = 'I', reformers = {'LAlt'}}},		down = hotas_commands.SSS_RIGHT,					up = hotas_commands.SSS_RIGHT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select RIGHT: FLIR BH/WH'),			category = _('HOTAS')},
	{combos = {{key = 'N', reformers = {'LAlt'}}},		down = hotas_commands.SSS_CENTER,					up = hotas_commands.SSS_CENTER,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select DOWN: HUD Scene Reject/TGP'),	category = _('HOTAS')},
	...
	{combos = {{key = 'B',   reformers = {'LShift'}}},	pressed = iCommandPlaneAirBrakeOn,	up = iCommandHelicopter_PPR_button_K_up,	name = _('Airbrake OUT'),			category = _('HOTAS')},
	{combos = {{key = 'B',   reformers = {'LCtrl'}}},	pressed = iCommandPlaneAirBrakeOff,	up = iCommandHelicopter_PPR_button_K_up,	name = _('Airbrake IN'),			category = _('HOTAS')},    
	...
	{combos = {{key = 'M', reformers = {'LCtrl'}}},	down = iCommandSwitchMasterArm,																name = _('Master Arm Switch Toggle'),	category = _('Armament Control')},
	{combos = {{key = 'F', reformers = {'LCtrl'}}},	pressed = iCommandPlaneCMDChangeBurstAmount,	up = iCommandPlaneCMDChangeBurstAmountOff,	name = _('Launch Flare Salvo'),			category = _('Armament Control')},
  ...
  {down = int_light_commands.Knob_Annunciator_Lights, cockpit_device_id = devices.LTINT, value_down = -0.1, name = _("Annunciator Lights Decrease"), category = _('Internal Lights')},
	...
	{combos = {{key = 'Space', reformers = {'RWin'}}},		down = iCommandPlane_SPU9_radio_change,	value_down = 1,	name = _('Change Mission Route Map Page'),								category = {_('Ground Adjustments')}},
	{combos = {{key = '1', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_31,	value_down = 1,	name = _('Change APKWS Laser Code X100'),								category = {_('Ground Adjustments')}},
	{combos = {{key = '2', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_32,	value_down = 1,	name = _('Change APKWS Laser Code X010'),								category = {_('Ground Adjustments')}},
	{combos = {{key = '3', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_33,	value_down = 1,	name = _('Change APKWS Laser Code X001'),								category = {_('Ground Adjustments')}},
	{combos = {{key = '4', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_34,	value_down = 1,	name = _('Change GBU-12/16 Laser Code X100'),							category = {_('Ground Adjustments')}},
	{combos = {{key = '5', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_35,	value_down = 1,	name = _('Change GBU-12/16 Laser Code X010'),							category = {_('Ground Adjustments')}},
	{combos = {{key = '6', reformers = {'LShift','LAlt'}}},	down = iCommandPlaneCircuitBreaker_36,	value_down = 1,	name = _('Change GBU-12/16 Laser Code X001'),							category = {_('Ground Adjustments')}},
