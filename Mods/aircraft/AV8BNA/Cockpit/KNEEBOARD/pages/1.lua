...
txt_GR20_Laser_Code.init_pos		= {Base_Col_2,  Base_Row_5, 0}
...
txt_GBUS_Laser_Code					= CreateElement "ceStringPoly"
txt_GBUS_Laser_Code.name			= "txt_GBUs_Laser_Code"
txt_GBUS_Laser_Code.material		= "font_hints_kneeboard"
txt_GBUS_Laser_Code.init_pos		= {Base_Col_2,  Base_Row_5 - LineSizeY * 1.25, 0}
txt_GBUS_Laser_Code.formats			= {"%d"}
txt_GBUS_Laser_Code.alignment		= "LeftCenter"
txt_GBUS_Laser_Code.parent_element	= HintsBase.name
txt_GBUS_Laser_Code.stringdefs		= predefined_font_07
txt_GBUS_Laser_Code.controllers		= {{"GBUs_LaserCode"}}
AddElement(txt_GBUS_Laser_Code)
