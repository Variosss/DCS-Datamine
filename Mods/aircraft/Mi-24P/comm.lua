...
menus['Wheel chocks plus'] = {
	name = _('Wheel chocks and tie-downs'),
	items = {
		[1] = {name = _('Place wheel chocks'),  command = sendMessage.new(Message.wMsgLeaderGroundToggleWheelChocks, true)},
		[2] = {name = _('Remove wheel chocks'), command = sendMessage.new(Message.wMsgLeaderGroundToggleWheelChocks, false)}
	},
}

menus['Exhaust screen plus'] = {
	name = _('Exhaust screen'),
	items = {
		[1] = {name = _('Install exhaust screen'),  command = sendMessage.new(Message.wMsgLeaderGroundToggleExhaustScreen, true)},
		[2] = {name = _('Remove exhaust screen'), command = sendMessage.new(Message.wMsgLeaderGroundToggleExhaustScreen, false)}
	},
}

local g_crew_items = menus['Ground Crew'].items
g_crew_items[#g_crew_items  + 1] = { name = _('Wheel chocks and tie-downs'), submenu = menus['Wheel chocks plus']}
g_crew_items[#g_crew_items  + 1] = { name = _('Exhaust screen'), condition = {check = function(self) return data.customUnitProperties["ExhaustScreen"].value == 1 end}, submenu = menus['Exhaust screen plus']}