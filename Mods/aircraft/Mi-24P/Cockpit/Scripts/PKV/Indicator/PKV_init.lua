...
page_subsets = {}
page_subsets[id_pagesubset.SIGHT_BASE] = LockOn_Options.script_path.."PKV/Indicator/PKV_base_page.lua"
page_subsets[id_pagesubset.SIGHT_COMMON] = LockOn_Options.script_path.."PKV/Indicator/PKV_page.lua"
