...
SymbologyBox_sizeX 	= 125
SymbologyBox_sizeY  = 135
SymbologyBox_sizeY_min = 60
SymbologyBox_sizeY_1  = 85
SymbologyBox_sizeX_1  = 110
SymbologyBox_sizeX_2 = 55
...
SymbologyBox.vertices	= {
							...
							{ SymbologyBox_sizeX, SymbologyBox_sizeY_min},
							{ SymbologyBox_sizeX, -SymbologyBox_sizeY},
							{ -SymbologyBox_sizeX_1, SymbologyBox_sizeY_1},
							{SymbologyBox_sizeX_1, SymbologyBox_sizeY_1},
							{ -SymbologyBox_sizeX_2, SymbologyBox_sizeY - 3},
							{SymbologyBox_sizeX_2, SymbologyBox_sizeY - 3},
							{0.0, SymbologyBox_sizeY + 10},
						}						
						

SymbologyBox.indices		 = {0,1,2,
								2,3,0,
								1,2,4,
								4,6,2,
								6,5,2,
...
SymbologyBox.init_rot		 = {0.0, 0.0, -40.0}
...
total_field_of_view.init_pos		 = {0.0, -20.0, 0.0}
