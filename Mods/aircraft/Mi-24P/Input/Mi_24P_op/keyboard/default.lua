...
{combos = {{key = '\\', 	reformers = {'RAlt'}}},			 down = SPU_8_Mi24_commands.CMD_SPU8_TRIGGER_EXT,	up = SPU_8_Mi24_commands.CMD_SPU8_TRIGGER_EXT, cockpit_device_id = devices.SPU_8, value_down = 1.0, value_up = 0.0,	name = _('Radio trigger - RADIO (call radio menu)'), category = {_('Ins Cyclic Stick'), _('Communications')}},
{combos = {{key = 'Space',	reformers = {'RShift'}}},		 down = SPU_8_Mi24_commands.CMD_SPU8_TRIGGER_EXT,	up = SPU_8_Mi24_commands.CMD_SPU8_TRIGGER_EXT, cockpit_device_id = devices.SPU_8, value_down = 0.5, value_up = 0.0,	name = _('Radio trigger - ICS (call radio menu)'), category = {_('Ins Cyclic Stick'), _('Communications')}},
...
{combos = {{key = '1'}},	down = iCommandViewCockpitChangeSeat,	value_down = 1, name = _('Set Pilot Seat'),		category = _('View Cockpit')},
{combos = {{key = '2'}},	down = iCommandViewCockpitChangeSeat,	value_down = 2, name = _('Set Operator Seat'),	category = _('View Cockpit')},
{combos = {{key = '3'}},	down = iCommandViewCockpitChangeSeat,	value_down = 3, name = _('Set Gunner Seat'),	category = _('View Cockpit')},
{combos = {{key = 'T', reformers = {'LAlt'}}},	down = headwrapper_commands.TrackIR_OnOff, cockpit_device_id = devices.HEAD_WRAPPER, value_down = 0.0,	name = _('TrackIR Aiming On/Off'),		category = _('View Cockpit')},
...
{combos = {{key = 'L', reformers = {'RCtrl'}}}, down = i9K113_commands.Command_9k113_Backlight_Ext, cockpit_device_id = devices.I9K113, value_down = 1,	name = _('LIGHTS (Backlight)'),						category = {_('9K113')}},
...
{combos = {{key = 'R', reformers = {'LAlt'}}}, down = i9K113_commands.Command_RadiationReset_Ext, up = i9K113_commands.Command_RadiationReset_Ext,		cockpit_device_id = devices.I9K113, value_down = 1, value_up = 0,	name = _('Radiation Reset'),						category = {_('9K113')}},
...
{combos = {{key = 'I', reformers = {'RCtrl'}}}, 			down = iCommandPlaneRadarCenter, value_down = 1, name = _('9K113, missile control console - knobs in neutral'), category = _('9K113')},
{combos = {{key = '='}}, down = iCommandPlaneZoomIn, 		value_down = 1, name = _('Zoom In'), category = _('9K113')},
{combos = {{key = '-'}}, down = iCommandPlaneZoomOut, 		value_down = 1, name = _('Zoom Out'), category = _('9K113')},
...
{combos = {{key = '1', reformers = {'LAlt'}}}, down = weapon_commands.SWITCHER_WEAP_TYPE_AB_Ext, cockpit_device_id = devices.WEAP_SYS, value_down = 0,			name = _('Select Weapon Operator 1 OFF MSL'),		category = {_('Weapon Panel')}},
{combos = {{key = '2', reformers = {'LAlt'}}}, down = weapon_commands.SWITCHER_WEAP_TYPE_AB_Ext, cockpit_device_id = devices.WEAP_SYS, value_down = 0.1,		name = _('Select Weapon Operator 2 GM-30'),			category = {_('Weapon Panel')}},
{combos = {{key = '3', reformers = {'LAlt'}}}, down = weapon_commands.SWITCHER_WEAP_TYPE_AB_Ext, cockpit_device_id = devices.WEAP_SYS, value_down = 0.2,		name = _('Select Weapon Operator 3 ROCKET'),		category = {_('Weapon Panel')}},
{combos = {{key = '4', reformers = {'LAlt'}}}, down = weapon_commands.SWITCHER_WEAP_TYPE_AB_Ext, cockpit_device_id = devices.WEAP_SYS, value_down = 0.3,		name = _('Select Weapon Operator 4 BOMB'),			category = {_('Weapon Panel')}},
{combos = {{key = '5', reformers = {'LAlt'}}}, down = weapon_commands.SWITCHER_WEAP_TYPE_AB_Ext, cockpit_device_id = devices.WEAP_SYS, value_down = 0.4,		name = _('Select Weapon Operator 5 USLP'),			category = {_('Weapon Panel')}},

--Gunners AI Panel
{combos = {{key = 'H', reformers = {'LShift'}}}, 			down = weapon_commands.CMD_GAI_CTL_SHOW, 	cockpit_device_id = devices.WEAP_SYS, value_down = 1.0, name = _('AI Panel Show/Hide'), 		category = _('Gunners AI Panel')},
{combos = {{key = '3', reformers = {'LCtrl', 'LWin'}}},	 	down = weapon_commands.CMD_GAI_CTL_GUNNER, 	cockpit_device_id = devices.WEAP_SYS, value_down = 0.0, name = _('AI Gunner ROE Iterate'), 	category = _('Gunners AI Panel')},
{combos = {{key = '3', reformers = {'LShift', 'LWin'}}}, 	down = weapon_commands.CMD_GAI_CTL_GUNNER, 	cockpit_device_id = devices.WEAP_SYS, value_down = 0.1, name = _('AI Gunner Burst Switch'), 	category = _('Gunners AI Panel')},
{combos = {{key = 'K', reformers = {'RAlt','RShift'}}},		down = weapon_commands.CMD_Show_Gunners_Panel,	cockpit_device_id = devices.WEAP_SYS,		value_down = 1.0,	name = _('Show Gunners Panel'),	category = {_('Hints'), _('Armament System')}},


--ASP-17
{combos = {{key = 'U'}},  						down = asp_commands.USR_ITER, 	    cockpit_device_id = devices.ASP_17V,    value_down =  1.0,	name = _('USR power - ON/OFF'),		category = {_('ASP-17V')}},
{combos = {{key = 'U', reformers = {'RCtrl'}}}, down = asp_commands.USR_EXT,		cockpit_device_id = devices.ASP_17V,	value_down =  0.0,	name = _('USR power - OFF'),		category = {_('ASP-17V')}},
{combos = {{key = 'U', reformers = {'LAlt'}}},	down = asp_commands.USR_EXT,		cockpit_device_id = devices.ASP_17V,	value_down =  1.0,	name = _('USR power - ON'),			category = {_('ASP-17V')}},
...
-- gear lever:
{combos = {{key = 'G', reformers = {'LCtrl'}}},				down = iCommandPlaneGearUp,																																												value_down = 1,							name = _('Gear Lever - UP'),										category = {_('Left Instrument Panel')}},
{combos = {{key = 'G', reformers = {'LShift'}}},			down = iCommandPlaneGearDown,																																											value_down = 0,							name = _('Gear Lever - DOWN'),										category = {_('Left Instrument Panel')}},
{combos = {{key = 'G'}},									down = iCommandPlaneGear,																																												value_down = 1,							name = _('Gear Lever - UP/DOWN'),									category = {_('Left Instrument Panel')}},
...
-- Anti Ice System
-- {combos = {{key = 'W', reformers = {'LShift','RShift'}}},down = AntiIceSys_commands.ANTIICE_GLAZING_O_EXT, cockpit_device_id = devices.ANTI_ICE_INTERFACE, value_down = 1,  value_up = 0, name = _('Windshield Anti-Ice switch - toggle'),			category = _('Left Side Operator Panel')},
