...
{action = weapon_commands.Gunner_SIGHT_UP_DOWN_AXIS, cockpit_device_id = devices.WEAP_SYS, name = _('Gun Up/Down')},
{action = weapon_commands.Gunner_SIGHT_LEFT_RIGHT_AXIS, cockpit_device_id = devices.WEAP_SYS, name = _('Gun Left/Right')},

{combos = {{key = 'MOUSE_X'}}, action = weapon_commands.Gunner_WS_CMD_HAngle, cockpit_device_id = devices.WEAP_SYS, name = _('Camera Horizontal View')},
{combos = {{key = 'MOUSE_Y'}}, action = weapon_commands.Gunner_WS_CMD_VAngle, cockpit_device_id = devices.WEAP_SYS, name = _('Camera Vertical View')},
