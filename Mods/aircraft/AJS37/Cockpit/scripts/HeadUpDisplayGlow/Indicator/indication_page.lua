...
dofile(LockOn_Options.script_path.."HeadUpDisplayGlow/Indicator/definitions.lua")
...
local BASE_COLOR = {118, 230, 255, 100} -- green {255,255,255,255} -- white local BASE_COLOR = {118, 240, 145, 215} 
