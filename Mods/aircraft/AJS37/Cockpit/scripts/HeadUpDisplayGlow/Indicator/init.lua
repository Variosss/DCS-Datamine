...
page_subsets= {
	[BASE]		= LockOn_Options.script_path.."HeadUpDisplayGlow/Indicator/base_page.lua",
	[INDICATION]= LockOn_Options.script_path.."HeadUpDisplayGlow/Indicator/indication_page.lua",
}
