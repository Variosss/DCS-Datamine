...
local keycommands = {
	-- Autopilot
    {combos = {{key = 'J'}}, down = 3104, cockpit_device_id = devices.ENGINEPANEL, value_down = 1.0, name = _('Autothrottle mode AFK (toggle)'), category = _('Autopilot')},
    ...
    {combos = {{key = 'H', reformers = {'RAlt'}}}, down = 3401, cockpit_device_id = devices.FLIGHTDATAUNIT, value_down = 1.0, name = _('HUD Position LOW/HIGH (toggle)'), category = _('Navigation')}, 
    ...
    {combos = {{key = 'Z', reformers = {'RCtrl'}}},cockpit_device_id = devices.FLIGHTDATAUNIT,  down = 3713, up = 3713, value_down =-1.0, value_up =0.0, name = _('Trim: Rudder Left'), category = _('Flight Control')},
    {combos = {{key = 'X', reformers = {'RCtrl'}}},cockpit_device_id = devices.FLIGHTDATAUNIT,  down = 3713, up = 3713, value_down =1.0, value_up =0.0, name = _('Trim: Rudder Right'), category = _('Flight Control')},
    {combos = {{key = 'Z', reformers = {'RAlt','RCtrl'}}},cockpit_device_id = devices.FLIGHTDATAUNIT,  pressed = 3712, value_pressed =-1.0, name = _('Autopilot yaw trim Left'), category = _('Autopilot')},
    {combos = {{key = 'X', reformers = {'RAlt','RCtrl'}}}, cockpit_device_id = devices.FLIGHTDATAUNIT, pressed = 3712, value_pressed =1.0, name = _('Autopilot yaw trim Right'), category = _('Autopilot')},
    ...
    {combos = {{key = 'G'}}, down = 3723,value_down =1,  cockpit_device_id = devices.FLIGHTDATAUNIT,  name = _('Landing Gear Up/Down (toggle)'), category = _('Flight Control')},
    ...
    {combos={{key='W',reformers={'LCtrl','LAlt'}}},down = 3413, cockpit_device_id = devices.FLIGHTDATAUNIT, value_down =1.0, name = _('Parking brake (toggle)'), category = _('Flight Control')},
    ...
    {combos = {{key = "C", reformers = {"LAlt", "LShift"}}}, down = 3101, up = 3101, cockpit_device_id = devices.NAVIGATIONPANEL, value_down = 1.0, value_up = 0.0, name = _("Data panel RENSA cover"), category = _("Data panel")},
    ...
    {combos = {{key = "M"}}, down = 3212, up = 3212, cockpit_device_id = devices.RADAR, value_down = 1.0, value_up = 0.0, name = _("Memory mode"), category = _("Radar")},
    {combos = {{key = "H", reformers = {"LCtrl"}}}, down = 3213, cockpit_device_id = devices.RADAR, value_down = 1.0, up = 3213, value_up = 0.0, name = _("Radar Terrain Avoidance Mode"), category = _("Radar")},
    ...
    {down = 3323, cockpit_device_id = devices.RADAR, value_down = 1.0, up = 3323, value_up = 0.0, name = _('Radar Range Increase'), category = _('Radar')},  
    {down = 3323, cockpit_device_id = devices.RADAR, value_down = -1.0, up = 3323, value_up = 0.0, name = _('Radar Range Decrease'), category = _('Radar')}, 
    {pressed = 3326, cockpit_device_id = devices.RADAR, value_pressed = 1.0, name = _('Radar MKR Gain Increase'), category = _('Radar')}, 
    {pressed = 3326, cockpit_device_id = devices.RADAR, value_pressed = -1.0, name = _('Radar MKR Gain Decrease'), category = _('Radar')},
    ...
    {combos = {{key = "A", reformers = {"LCtrl","LAlt", "LShift"}}}, down = 3711, value_down = 1.0, cockpit_device_id = devices.FLIGHTDATAUNIT, name = _("Altimeter setting pull-out (toggle)"), category = _("Flight Data")},
    ...
    {combos = {{key = "X", reformers = {"RShift","RCtrl"}}}, down = 3200, cockpit_device_id = devices.FLIGHTDATAUNIT, value_down = 1.0, name = _("HÖJD CISI (toggle)"), category = _("Navigation")},
    ...
    {combos = {{key = "I", reformers = {"LAlt"}}}, down = 3005, cockpit_device_id = devices.ENGINEPANEL, value_down = 1.0, name = _("High-pressure fuel valve (toggle)"), category = _("Motor")},
    ...
    {combos = {{key = "M", reformers = {"RAlt"}}}, down = 3009, cockpit_device_id = devices.ENGINEPANEL, value_down = 1.0, name = _("Manual fuel regulator switch (toggle)"), category = _("Motor")},
    ...
    {combos = {{key = "I", reformers = {"RAlt"}}}, down = 3008, cockpit_device_id = devices.ENGINEPANEL, value_down = 1.0, name = _("Engine De-ice switch (toggle)"), category = _("Motor")},
    {combos = {{key = "R", reformers = {"RAlt"}}}, down = 3003, cockpit_device_id = devices.RADARALT, value_down = 1.0, name = _("Radar altimeter switch (toggle)"), category = _("Flight Data")},
    ...
    {down = 3004, cockpit_device_id = devices.LIGHTS, value_down = 1.0, name = _('Position lights switch'), category = _('Lights')},
    ...
    {combos = {{key = 'D', reformers = {'LCtrl', "LAlt"}}},down = 3503, value_down = 1.0, cockpit_device_id = devices.WEAPON_SYSTEM, name = _('Cycle Ground Crew Regroup Selection'), category = _('Weapons')},
    ...
    {combos = {{key = 'M', reformers = {'LCtrl', "LShift"}}},down = 3001, value_down = 1.0, cockpit_device_id = devices.MISSIONGENERATOR, name = _('Generated Cartridge Increase Time Margin'), category = _('Navigation')},
    {combos = {{key = 'M', reformers = {'LCtrl', "LAlt"}}},down = 3001, value_down = -1.0, cockpit_device_id = devices.MISSIONGENERATOR, name = _('Generated Cartridge Decrease Time Margin'), category = _('Navigation')},
    ...
    {down = 3926, value_down = 1.000000, cockpit_device_id = devices.WEAPON_SYSTEM, name = _('Trigger safety bracket TOGGLE'), category = _('Weapons')},
    ...
    {combos = {{key = 'H', reformers = {'LShift'}}},down = 3421,            cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0,                 name = _('Cycle Weapon Safety Height'), category = _('Weapons')},
    {combos = {{key = 'Q', reformers = {'LShift'}}},down = 3422,            cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0,                 name = _('Cycle Left RB04 Group Target'), category = _('Weapons')},
    {combos = {{key = 'W', reformers = {'LShift'}}},down = 3423,            cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0,                 name = _('Cycle Right RB04 Group Target'), category = _('Weapons')},
    {combos = {{key = 'A', reformers = {'LShift'}}},down = 3424,            cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0,                 name = _('Cycle Left RB04 Jump Angle'), category = _('Weapons')},
    {combos = {{key = 'S', reformers = {'LShift'}}},down = 3425,            cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0,                 name = _('Cycle Right RB04 Jump Angle'), category = _('Weapons')},
	-- radios
    ...
    --Kneeboard controls
    {combos = {{key = 'PageUp', reformers = {'RShift'}}}, down = 3060, cockpit_device_id = devices.KNEEBOARDINTERFACE, value_down = 1.0, value_up = 0.0, name = _('Kneeboard Next Subpage'), category = _('Kneeboard')},
    {combos = {{key = 'PageDown', reformers = {'RShift'}}}, down = 3060, cockpit_device_id = devices.KNEEBOARDINTERFACE, value_down = -1.0, value_up = 0.0, name = _('Kneeboard Previous Subpage'), category = _('Kneeboard')},
