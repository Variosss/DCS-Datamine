...
txt_INS_status					= create_HUD_element("ceStringPoly")
txt_INS_status.name				= "txt_INS_status"
txt_INS_status.material			= "font_Ka-50_HUD"
txt_INS_status.init_pos			= {0.0, -0.32 + vertical_displacement, 0}
txt_INS_status.alignment		= "CenterTop"
txt_INS_status.formats 			= {"ИКВ\nУВ", "ИКВ\nНВ", "ИКВ\nВГП", "ИКВ\nТВ"}
txt_INS_status.stringdefs		= {0.0073, 0.0073, -0.0007, 0.0009}
txt_INS_status.controllers		= {{"txt_INS_status"}}
AddWithDefaultClip(txt_INS_status)

-- TODO: to display the rest of malfunctions ('К/КУК-1' mode). To rename it respectively.
txt_IMU_malfunction					= create_HUD_element("ceStringPoly")
txt_IMU_malfunction.name			= "txt_IMU_malfunction"
txt_IMU_malfunction.material		= "font_Ka-50_HUD"
txt_IMU_malfunction.init_pos		= {0.0, -0.32 + vertical_displacement, 0}
txt_IMU_malfunction.alignment		= "CenterTop"
txt_IMU_malfunction.formats 		= {"ОТКАЗ\nИКВ"}
txt_IMU_malfunction.stringdefs		= {0.0073, 0.0073, -0.0007, 0.0009}
txt_IMU_malfunction.controllers		= {{"txt_IMU_malfunction"}}
AddWithDefaultClip(txt_IMU_malfunction)
...
underline.parent_element			= txt_INS_status.name
AddWithDefaultClip(underline)

underline_IMU_malfunction			= Copy(underline)
underline_IMU_malfunction.parent_element = txt_IMU_malfunction.name
AddWithDefaultClip(underline_IMU_malfunction)
