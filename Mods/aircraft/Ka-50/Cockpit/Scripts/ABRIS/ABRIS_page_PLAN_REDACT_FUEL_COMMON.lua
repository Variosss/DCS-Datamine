...
local verts_cursor     =  {{-0.99*x_size, 1.2*new_delta},
						   {0*x_size, 1.2*new_delta},
						   {0*x_size,-0.2*new_delta},
						   {-0.99*x_size,-0.2*new_delta},

						   {0*x_size, 2.2*new_delta},
...
txt_journal_segment_data_header[1].value            = LOCALIZE("Gост")
...
txt_journal_segment_data_header[4].init_pos		    = {0.65*x_size,0,0}
txt_journal_segment_data_header[4].alignment        = "RightTop"
txt_journal_segment_data_header[4].stringdefs       = abris_font[8]
txt_journal_segment_data_header[4].value            = LOCALIZE("Qчас")
...
txt_journal_segment_data_header[5].init_pos		    = {1.05*x_size,0,0}
