...
txt_journal_segment_data_header[1].init_pos		    = {-0.2*x_size,3.7*new_delta,0}
txt_journal_segment_data_header[1].alignment        = "CenterTop"
txt_journal_segment_data_header[1].stringdefs       = abris_font[8]
txt_journal_segment_data_header[1].value            = LOCALIZE("ВЕТЕР")
