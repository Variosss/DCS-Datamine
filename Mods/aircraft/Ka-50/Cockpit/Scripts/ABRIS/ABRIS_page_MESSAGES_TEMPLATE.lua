...
txt_item_data2			   	    = Copy(txt_item_data)
txt_item_data2.formats		    = {"\t\t\t\t\t\t%02.f:%02.f:%02.f"}
txt_item_data2.controllers      = {{"message_time",0}}
txt_item_data2.parent_element   = txt_item_data.name
SetDefaultClipWithLevel(txt_item_data2,2)
Add(txt_item_data2)
