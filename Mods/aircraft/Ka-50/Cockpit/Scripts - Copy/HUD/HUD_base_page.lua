...
local collimator_border_near    		= ellipse(1.2,0.75 * 1.2,math.rad(48),-math.rad(48))
...
local collimator_border_far    			= ellipse(1.35,0.75 * 1.2,math.rad(75),-math.rad(75))
collimator_border_far.init_pos	  		= {0.0, 0.14, 0.85}
collimator_border_far.init_rot   		= {180, 0.0, 46.0}
