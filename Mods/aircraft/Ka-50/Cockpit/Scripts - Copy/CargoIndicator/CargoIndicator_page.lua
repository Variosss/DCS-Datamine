...
NarrowCircle.controllers    = {{"show"},{"narrow_position",aspect-box_width--[[-narrow_width*size_narrow--]],1.0-box_height--[[narrow_height*size_narrow--]]}}
...
circle.controllers    = {{"show"},{"circle_position",aspect-box_width,1.0-box_height}--[[,{"radius"}--]]}
...
zone1 						= CreateElement "ceMeshPoly"
zone1.name       			=  "zone1"
zone1.primitivetype 		= "triangles"
zone1.material  		 	= "BLUE"
zone1.vertices       = {{-line_width*5	, -size},
                         {-line_width*5	, size}, 
                         { line_width*5	, size},
                         { line_width*5	,-size}}     
zone1.indices        = default_box_indices
zone1.controllers    = {{"show"}}
zone1.init_pos       = {aspect-0.06,1.0-box_height}
zone1.level		 = DEFAULT_LEVEL
zone1.h_clip_relation  = h_clip_relations.REWRITE_LEVEL
...
zone.material  		 	= "RED"
zone.vertices       = {{-line_width*5	, -0.8*size},
                         {-line_width*5	, 0.8*size}, 
                         { line_width*5	, 0.8*size},
                         { line_width*5	,-0.8*size}}     
...
heightnarrow.controllers    = {{"show"},{"height_narrow_position",aspect-0.06,1.0-box_height}}
