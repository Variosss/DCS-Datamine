...
txt_journal_segment_current_data_goto.init_pos		 = {0,0.1*new_delta,0}
...
txt_journal_segment_current_data_from.init_pos		 = {0,0.1*new_delta,0}
...
txt_journal_segment_data[1].init_pos		 = {x_size + x_pos[1],0.1*new_delta,0}
