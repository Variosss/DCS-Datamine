...
txt_journal_segment_data[5].controllers      = {{"inserted_segment_redactor_value",0,1}}
...
txt_journal_segment_data[13].init_pos		  = {0.45*x_size,0,0}
txt_journal_segment_data[13].material         = "font_Ka-50_ABRIS_WHITE"
txt_journal_segment_data[13].alignment        = "CenterCenter"
txt_journal_segment_data[13].stringdefs       = abris_font[8]
txt_journal_segment_data[13].formats		  = {"%s"}
txt_journal_segment_data[13].controllers      = {{"inserted_segment_redactor_value",0,15}}
