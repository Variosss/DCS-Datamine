...
txt_journal_segment_data[3].init_pos		 = {0.6*x_size,0,0}
txt_journal_segment_data[3].alignment        = "RightTop"
txt_journal_segment_data[3].stringdefs       = abris_font[8]
txt_journal_segment_data[3].formats          = {"%05.f"}
txt_journal_segment_data[3].controllers      = {{"journal_segment_preset_remaining_fuel",0},{"current_menu_item_change_color",0,0,0}}
...
txt_journal_segment_data[4].init_pos		 = {1.3*x_size,new_delta,0}
txt_journal_segment_data[4].alignment        = "RightTop"
txt_journal_segment_data[4].stringdefs       = abris_font[8]
txt_journal_segment_data[4].formats          = {"%05.f"}
txt_journal_segment_data[4].controllers      = {{"journal_segment_preset_fuel_consumption",0},{"current_menu_item_change_color",0,0,0}}
