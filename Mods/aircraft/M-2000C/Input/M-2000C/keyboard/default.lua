...
join(res.keyCommands,{
	...
	{category = _('HOTAS'), name = _('MiCRoB/Trigger 2nd Stage'),					down = cmds.MICROB_2,		up = cmds.MICROB_2,	value_up = 0, value_down = 1,					combos = {{key = 'Space'}},						},
	{category = _('HOTAS'), name = _('Autopilot Standby Mode'),						down = iCommandPlaneAutopilotOverrideOn,	up = iCommandPlaneAutopilotOverrideOff,				combos = {{key = 'A', reformers = {'LAlt'}}},	},
	{category = _('HOTAS'), name = _('Nosewheel Steering/IFF Interrogate'),			down = iCommandPlane_HOTAS_BoatSwitchAft,	up = iCommandPlane_HOTAS_BoatSwitchForward,			combos = {{key = 'S'}},							},
	{category = _('HOTAS'), name = _('STT/TWS Toggle'),								down = cmds.RadarSTT,																			combos = {{key = 'Enter'}},						},
	{category = _('HOTAS'), name = _('Trim UP'),									pressed = iCommandPlaneTrimUp,				up = iCommandPlaneTrimStop,							combos = {{key = 'S', reformers = {'RCtrl'}}},	},
	{category = _('HOTAS'), name = _('Trim DOWN'),									pressed = iCommandPlaneTrimDown,			up = iCommandPlaneTrimStop,							combos = {{key = 'W', reformers = {'RCtrl'}}},	},
	{category = _('HOTAS'), name = _('Trim LEFT'),									pressed = iCommandPlaneTrimLeft,			up = iCommandPlaneTrimStop,							combos = {{key = 'A', reformers = {'RCtrl'}}},	},
	{category = _('HOTAS'), name = _('Trim RIGHT'),									pressed = iCommandPlaneTrimRight,			up = iCommandPlaneTrimStop,							combos = {{key = 'D', reformers = {'RCtrl'}}},	},
	{category = _('HOTAS'), name = _('Decoy Program release'),						down = iCommandPlaneDropFlareOnce,																combos = {{key = 'Delete'}},					},
	{category = _('HOTAS'), name = _('Autopilot Disconnect/Exceed Elastic Limit'),	down = iCommandPlane_HOTAS_PinkySwitchAft,	up = iCommandPlane_HOTAS_PinkySwitchForward,		combos = {{key = 'A', reformers = {'LShift'}}},	},
	...
	--HOTAS Throttle
	{category = _('HOTAS'), name = _('CNM AA Gun'),										down = iCommandPlaneModeCannon,																combos = {{key = 'C'}},								},
	{category = _('HOTAS'), name = _('V/UHF GREEN Radio Menu'),							down = cmds.VUHF_Menu,																		combos = {{key = 'Num+', reformers = {'LShift'}}},	},
	{category = _('HOTAS'), name = _('UHF RED Radio Menu'),								down = cmds.UHF_Menu,																		combos = {{key = 'Num-', reformers = {'LAlt'}}},	},
	...
	{category = _('HOTAS'), name = _('Airbrake TOGGLE'),								down = iCommandPlaneAirBrake,																combos = {{key = 'B'}},								},
	{category = _('HOTAS'), name = _('Airbrake ON'),									down = iCommandPlaneAirBrakeOn,																combos = {{key = 'B',   reformers = {'LShift'}}},	},
	{category = _('HOTAS'), name = _('Airbrake OFF'),									down = iCommandPlaneAirBrakeOff,															combos = {{key = 'B',   reformers = {'LCtrl'}}},	},
	{category = _('HOTAS'), name = _('TDC UP'),											down = cmds.TDC_V,	up = cmds.TDC_V,		value_down = 1, value_up = 0,					combos = {{key = ';'}},								},
	{category = _('HOTAS'), name = _('TDC DOWN'),										down = cmds.TDC_V,	up = cmds.TDC_V,		value_down =-1, value_up = 0,					combos = {{key = '.'}},								},
	{category = _('HOTAS'), name = _('TDC LEFT'),										down = cmds.TDC_H,	up = cmds.TDC_H,		value_down =-1, value_up = 0,					combos = {{key = ','}},								},
	{category = _('HOTAS'), name = _('TDC RIGHT'),										down = cmds.TDC_H,	up = cmds.TDC_H,		value_down = 1, value_up = 0,					combos = {{key = '/'}},								},
	{category = _('HOTAS'), name = _('Decoy PANIC release'),							down = iCommandPlaneDropChaffOnce,															combos = {{key = 'Insert'}},						},
	...
	--PCA
	{category = _('PCA Weapons Management'), name = _('Gun Arm TOGGLE'),							down = iCommandPlaneAHCPGUNArm,																combos = {{key = '6', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Master Arm TOGGLE'),							down = iCommandSwitchMasterArm,																combos = {{key = '0'}},							},
	{category = _('PCA Weapons Management'), name = _('Selective Jettison TOGGLE'),					down = cmds.SelJett_TOGGLE, 																												},
	{category = _('PCA Weapons Management'), name = _('Smoke'),										down = iCommandPlaneWingtipSmokeOnOff,														combos = {{key = 'T'}},							}, 
	{category = _('PCA Weapons Management'), name = _('Emergency Jettison'),						cockpit_device_id = devices.PCA, down = 3409, up = 3409, value_down = 1, value_up = 0,		combos = {{key = 'E', reformers = {'LShift'}}},	},
	{category = _('PCA Weapons Management'), name = _('PCA Button 1 SELECT'),						cockpit_device_id = devices.PCA, down = 3235, up = 3235, value_down = 1, value_up = 0,		combos = {{key = '1'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 2 SELECT'),						cockpit_device_id = devices.PCA, down = 3237, up = 3237, value_down = 1, value_up = 0,		combos = {{key = '2'}},							},		
	{category = _('PCA Weapons Management'), name = _('PCA Button 3 SELECT'),						cockpit_device_id = devices.PCA, down = 3239, up = 3239, value_down = 1, value_up = 0,		combos = {{key = '3'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 4 SELECT'),						cockpit_device_id = devices.PCA, down = 3241, up = 3241, value_down = 1, value_up = 0,		combos = {{key = '4'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 5 SELECT'),						cockpit_device_id = devices.PCA, down = 3243, up = 3243, value_down = 1, value_up = 0,		combos = {{key = '5'}},							},
	{category = _('PCA Weapons Management'), name = _('AG Gun  SELECT'),							cockpit_device_id = devices.PCA, down = 3245, up = 3245, value_down = 1, value_up = 0,		combos = {{key = '0', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 1 SELECT'),							cockpit_device_id = devices.PCA, down = 3250, up = 3250, value_down = 1, value_up = 0,		combos = {{key = '1', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 2 SELECT'),							cockpit_device_id = devices.PCA, down = 3253, up = 3253, value_down = 1, value_up = 0,		combos = {{key = '2', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 3 SELECT'),							cockpit_device_id = devices.PCA, down = 3256, up = 3256, value_down = 1, value_up = 0,		combos = {{key = '3', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 4 SELECT'),							cockpit_device_id = devices.PCA, down = 3259, up = 3259, value_down = 1, value_up = 0,		combos = {{key = '4', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 5 SELECT'),							cockpit_device_id = devices.PCA, down = 3262, up = 3262, value_down = 1, value_up = 0,		combos = {{key = '5', reformers = {'LCtrl'}}},	},
	...
	-- Flight Control
	{category = _('Flight Control'), name = _('Aircraft Pitch DOWN'), 				pressed = iCommandPlaneUpStart,    up = iCommandPlaneUpStop,    			combos = {{key = 'Up'}},    							},
	{category = _('Flight Control'), name = _('Aircraft Pitch UP'),   				pressed = iCommandPlaneDownStart,  up = iCommandPlaneDownStop,  			combos = {{key = 'Down'}},  							},
	{category = _('Flight Control'), name = _('Aircraft Bank LEFT'),  				pressed = iCommandPlaneLeftStart,  up = iCommandPlaneLeftStop,  			combos = {{key = 'Left'}},  							},
	{category = _('Flight Control'), name = _('Aircraft Bank RIGHT'), 				pressed = iCommandPlaneRightStart, up = iCommandPlaneRightStop, 			combos = {{key = 'Right'}}, 							},
	{category = _('Flight Control'), name = _('Aircraft Rudder LEFT'),  			pressed = iCommandPlaneLeftRudderStart,  up = iCommandPlaneLeftRudderStop,  combos = {{key = 'Z'}}, 								},
	{category = _('Flight Control'), name = _('Aircraft Rudder RIGHT'), 			pressed = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop, combos = {{key = 'X'}}, 								},
	{category = _('Flight Control'), name = _('Throttle UP'),   					pressed = iCommandThrottleIncrease, up = iCommandThrottleStop,  			combos = {{key = 'Num+'}}, 								},
	{category = _('Flight Control'), name = _('Throttle DOWN'), 					pressed = iCommandThrottleDecrease, up = iCommandThrottleStop,  			combos = {{key = 'Num-'}}, 								},
	{category = _('Flight Control'), name = _('Trim RUDDER LEFT'),  				pressed = iCommandPlaneTrimLeftRudder,  up = iCommandPlaneTrimStop, 		combos = {{key = 'Z', reformers = {'RCtrl'}}}, 			},
	{category = _('Flight Control'), name = _('Trim RUDDER RIGHT'), 				pressed = iCommandPlaneTrimRightRudder, up = iCommandPlaneTrimStop, 		combos = {{key = 'X', reformers = {'RCtrl'}}}, 			},
	{category = _('Flight Control'), name = _('FBW G-Limiter Mode TOGGLE'), 		down = iCommandPlaneCobra,             										combos = {{key = 'G', reformers = {'LCtrl','LShift'}}}, },
	{category = _('Flight Control'), name = _('FBW Spin Switch TOGGLE'),    		down = iCommandPlaneEmerFlightControl, 										combos = {{key = 'V', reformers = {'LCtrl','LShift'}}}, },
	...
	-- External Lights
	{category = _('External Lights'), name = _('Landing Lights TOGGLE'),       	down = iCommandPlaneHeadLightOnOff,       							combos = {{key = 'L', reformers = {'RAlt'}}},           },
	{category = _('External Lights'), name = _('Formation Lights TOGGLE'),     	down = iCommandPlaneFormationLights,      							combos = {{key = 'L', reformers = {'RCtrl'}}},          },
	{category = _('External Lights'), name = _('Navigation Lights TOGGLE'),    	down = iCommandPlaneLightsOnOff,          							combos = {{key = 'L', reformers = {'RAlt','RCtrl'}}},   },
	{category = _('External Lights'), name = _('Anti-Collision Lights TOGGLE'),	down = iCommandPlaneAntiCollisionLights,  							combos = {{key = 'L', reformers = {'RShift','RCtrl'}}}, },
    ...
    {category = _('Hydraulic & Mechanical'), name = _('Canopy Position CYCLE'), 				down = cmds.CanopyFullAuto,	 													combos = {{key = 'C',   reformers = {'LCtrl'}}},	},
	...
	-- Pilot & Seat Controls    
	{category = _('Pilot & Seat Controls'), name = _('NVG Toggle'),						down = iCommandViewNightVisionGogglesOn,											combos = {{key = 'Home',reformers = {'LAlt'}}},			},
	{category = _('Pilot & Seat Controls'), name = _('Stow/Unstow NVG'),				down = iCommandPlaneDLK_Target3,													combos = {{key = 'Home',reformers = {'RShift'}}},		},
	{category = _('Pilot & Seat Controls'), name = _('Sun Visor Toggle'),				down = iCommandPlaneDLK_Target2,													combos = {{key = 'Home',reformers = {'LShift'}}},		},
	{category = _('Pilot & Seat Controls'), name = _('Toggle Mount NVG on helmet'),		down = iCommandPlaneDLK_Target1,													combos = {{key = 'Home',reformers = {'RAlt'}}},			},
	{category = _('Pilot & Seat Controls'), name = _('Pilot Body TOGGLE'),				down = iCommandCockpitShowPilotOnOff,												combos = {{key = 'P', reformers = {'RShift'}}},			},
	{category = _('Pilot & Seat Controls'), name = _('Mirrors TOGGLE'),					down = iCommandToggleMirrors,														combos = {{key = 'M', reformers = {'LShift'}}},			},
	{category = _('Pilot & Seat Controls'), name = _('Eject (3 times)'),				down = iCommandPlaneEject,															combos = {{key = 'E', reformers = {'LCtrl'}}},			},	
	{category = _('Pilot & Seat Controls'), name = _('Seat RAISE'),						pressed = iCommandPilotSeatAdjustmentUp, up = iCommandPilotSeatAdjustmentStop,		combos = {{key = 'S', reformers = {'LShift'}}},			},
	{category = _('Pilot & Seat Controls'), name = _('Seat LOWER'),						pressed = iCommandPilotSeatAdjustmentDown, up = iCommandPilotSeatAdjustmentStop,	combos = {{key = 'S', reformers = {'LShift','LAlt'}}},	},
	{category = _('Pilot & Seat Controls'),	name = _('Flight Clock START/STOP/RESET'), 	down = iCommandFlightClockReset, 													combos = {{key = 'C', reformers = {'RShift'}}}, 		},
	...
	{category = {_('Ground Adjustment')}, name = _('Change Matra Type 155 Burst Mode (1/3/6/18)'),	combos = {{key = '1', reformers = {'RShift','RAlt'}}},	down = cmds.Button_950, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Hundreds (1..8)'),		    combos = {{key = '9', reformers = {'RShift','RAlt'}}},	down = cmds.Button_951, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Tens (1..8)'),			    combos = {{key = '0', reformers = {'RShift','RAlt'}}},	down = cmds.Button_952, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Ones (1..8)'),			    combos = {{key = '-', reformers = {'RShift','RAlt'}}},	down = cmds.Button_953, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Gun Burst Lenght (0.5 or 1.0)'),	        combos = {{key = '2', reformers = {'RShift','RAlt'}}},	down = cmds.Button_954, cockpit_device_id = devices.PPA,	value_down = 1	},

	-- Communications
	{category = _('Communications'), name = _('Request AWACS Available Tanker'), 		down = iCommandAWACSTankerBearing,				combos = {{key = 'I', reformers = {'LWin'}}},											},
	{category = _('Communications'), name = _('Receive Mode'), 					 		down = iCommandToggleReceiveMode,				combos = {{key = '\\', reformers = {'RShift'}}, {key = 'M', reformers = {'RShift'}}},	},
	{category = _('Communications'), name = _('Tanker - Ready for precontact'),			down = iCommandPlaneRefuelingReadyPreContact,	combos = {{key = 'R', reformers = {'LWin'}}},											},

	-- Cheat
	{category = _('Cheat'), name = _('Start Procedure'), 	down = iCommandEnginesStart, 	combos = {{key = 'Home', 	reformers = {'LWin'}}},	},
    {category = _('Cheat'), name = _('Stop Procedure'),  	down = iCommandEnginesStop,  	combos = {{key = 'End', 	reformers = {'LWin'}}}, },
    {category = _('Cheat'), name = _('AoA Always visible'), down = cmds.AOA_Show,  			combos = {{key = 'A', 		reformers = {'LWin'}}}, },
	...
	{category = _('Debug'), name = _('Test Feature'),			down = iCommandPlane_ADF_Test			 , combos = {{key = 'D', reformers = {'LAlt'}}},	},
	{category = _('Debug'), name = _('Test Engine'),			down = iCommandHelicopter_Engine_Temperature_Control			 , combos = {{key = 'E', reformers = {'LAlt'}}},	},
