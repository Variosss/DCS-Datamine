...
pca_ur_base.name			= "PCA_UR"
pca_ur_base.material		= MakeMaterial(nil,{255,0,0,50})
pca_ur_base.h_clip_relation	= h_clip_relations.REWRITE_LEVEL  -- check clipping : pixel on glass then increase level from GLASS_LEVEL to GLASS_LEVEL+1 = HUD_DEFAULT_LEVEL
