...
page_subsets = {}
page_subsets[id_pagesubset.PILOT_SIGHT_BASE] = LockOn_Options.script_path.."PilotSight/Indicator/PilotSight_base_page.lua"
page_subsets[id_pagesubset.PILOT_SIGHT_COMMON] = LockOn_Options.script_path.."PilotSight/Indicator/PilotSight_page.lua"
