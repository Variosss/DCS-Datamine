...
{
	{
        ["file"] = "A-10C II-Training-Introduction.miz",
        ["name"] = _("Introduction to the A-10C II"),
	...
	{
        ["file"] = "A-10C II-Training-Takeoff and Handling.miz",
    ...
    },  
	{
        ...
        ["name"] = _("Navigation"),
        ["description"] = _("In this lesson, we will review the navigation systems of the A-10C II and practice navigation procedures."),
    },
	{
        ["file"] = "A-10C II-Training-Landing.miz",
        ["name"] = _("Landing"),
        ["description"] = _("In this lesson, we will practice landing the A-10C II using an ILS approach and review the shut-down procedure."),
    },
	{
        ["file"] = "A-10C II-Training-DSMS.miz",
        ["name"] = _("Digital Stores Management System (DSMS)"),
        ["description"] = _("In this lesson, we will overview the Digital Stores Management System (DSMS) of the A-10C II."),
    },
	{
        ["file"] = "A-10C II-Training-TGP.miz",
	...
	{
        ["file"] = "A-10C II-Training-Guns and Rockets.miz",
        ["name"] = _("GAU-8/A and Unguided Rockets"),
        ["description"] = _("In this lesson, we will overview employment of the GAU-8/A gun and unguided rockets carried by the A-10C II."),
    }, 
    {
        ["file"] = "A-10C II-Training-Unguided Bombs.miz",
        ["name"] = _("General Purpose Bombs"),
        ["description"] = _("In this lesson, we will overview the employment of unguided bombs in the A-10C II."),
    },
	{
        ["file"] = "A-10C II-Training-PGM.miz",
        ["name"] = _("Precision-Guided Munitions"),
        ["description"] = _("In this lesson, we will overview the employment of precision guided munitions in the A-10C II."),
    },
	{
        ["file"] = "A-10C II-Training-Maverick.miz",
	...
	{
        ["file"] = "A-10C II-Training-Laser MAV.miz",
        ["name"] = _("AGM-65L Laser Maverick"),
        ["description"] = _("In this lesson you will become familiar with employing the AGM-65L against a stationary target and a moving target."),
    },
	{
	...
	{
        ["file"] = "A-10C II-Training-Laser JDAM.miz",
        ["name"] = _("GBU-54A Laser JDAM"),
        ["description"] = _("In this lesson you will become familiar with employing the GBU-54A against a stationary target and a moving target."),
    },
	{
        ["file"] = "A-10C II-Training-Air to Air.miz",
        ["name"] = _("Air-to-air"),
    ...
    {
        ["file"] = "A-10C II-Training-Countermeasures.miz",
        ["name"] = _("Countermeasures (CMS)"),
        ["description"] = _("In this lesson, we will overview the countermeasures systems of the A-10C II."),
    },
} -- end of lessons
