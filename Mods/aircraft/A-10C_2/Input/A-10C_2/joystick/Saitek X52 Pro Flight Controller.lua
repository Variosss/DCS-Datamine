...
{combos = {{key = 'JOY_BTN15'}}, 	down = iCommandPlane_HOTAS_TriggerSecondStage, up = iCommandPlane_HOTAS_TriggerSecondStage_Off, name = _('Gun Trigger'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN20',reformers = {'LCtrl'}}},down = iCommandPlane_HOTAS_DataManagementSwitchUp,    up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = _('HOTAS DMS Forward'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN22',reformers = {'LCtrl'}}},down = iCommandPlane_HOTAS_DataManagementSwitchDown,  up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = _('HOTAS DMS Aft'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN23',reformers = {'LCtrl'}}},down = iCommandPlane_HOTAS_DataManagementSwitchLeft,  up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = _('HOTAS DMS Left'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN21',reformers = {'LCtrl'}}},down = iCommandPlane_HOTAS_DataManagementSwitchRight, up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = _('HOTAS DMS Right'), category = _('HOTAS')},

{combos = {{key = 'JOY_BTN20'}},down = iCommandPlane_HOTAS_TargetManagementSwitchUp,    up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = _('HOTAS TMS Forward'),   category = _('HOTAS')},
{combos = {{key = 'JOY_BTN22'}},down = iCommandPlane_HOTAS_TargetManagementSwitchDown,  up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = _('HOTAS TMS Aft'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN23'}},down = iCommandPlane_HOTAS_TargetManagementSwitchLeft,  up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = _('HOTAS TMS Left'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN21'}},down = iCommandPlane_HOTAS_TargetManagementSwitchRight, up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = _('HOTAS TMS Right'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN24'}},down = iCommandPlane_HOTAS_CoolieUp,    up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Up'),    category = _('HOTAS')},
{combos = {{key = 'JOY_BTN26'}},down = iCommandPlane_HOTAS_CoolieDown,  up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Down'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN27'}},down = iCommandPlane_HOTAS_CoolieLeft,  up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Left'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN25'}},down = iCommandPlane_HOTAS_CoolieRight, up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Right'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN10'}},down = iCommandPlane_HOTAS_ChinaHatAft, up = iCommandPlane_HOTAS_ChinaHatOff, name = _('HOTAS China Hat Aft'), category = _('HOTAS')},
{combos = {{key = 'JOY_BTN9'}} ,down = iCommandPlane_HOTAS_ChinaHatForward, up = iCommandPlane_HOTAS_ChinaHatOff, name = _('HOTAS China Hat Forward'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN4'}},down = iCommandPlane_HOTAS_MasterModeControlButton, up = iCommandPlane_HOTAS_MasterModeControlButtonUP, name = _('HOTAS Master Mode Control Button'), category = _('HOTAS')},
{combos = {{key = 'JOY_BTN6'}},down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff, name = _('HOTAS Nosewheel Steering Button'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_Z'}},  action = iCommandPlaneThrustCommon, name = _('Throttle Both')},
