...
{down = iCommandPlane_HOTAS_TriggerSecondStage, up = iCommandPlane_HOTAS_TriggerSecondStage_Off, name = _('Gun Trigger'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN_POV1_U'}},down = iCommandPlane_HOTAS_CoolieUp,    up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Up'),    category = _('HOTAS')},
{combos = {{key = 'JOY_BTN_POV1_D'}},down = iCommandPlane_HOTAS_CoolieDown,  up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Down'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN_POV1_L'}},down = iCommandPlane_HOTAS_CoolieLeft,  up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Left'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN_POV1_R'}},down = iCommandPlane_HOTAS_CoolieRight, up = iCommandPlane_HOTAS_CoolieOff, name = _('HOTAS Coolie Switch Right'), category = _('HOTAS')},

{combos = {{key = 'JOY_BTN10'}}	,down = iCommandPlane_HOTAS_BoatSwitchAft,up = iCommandPlane_HOTAS_BoatSwitchCenter, name = _('HOTAS Boat Switch : Aft<>Center'), category = { _("Special For Joystick"), _('HOTAS')}},
{combos = {{key = 'JOY_BTN9'}}	,down = iCommandPlane_HOTAS_BoatSwitchForward,up = iCommandPlane_HOTAS_BoatSwitchCenter, name = _('HOTAS Boat Switch : Forward<>Center'), category = { _("Special For Joystick"), _('HOTAS')}},

{combos = {{key = 'JOY_BTN12'}}	,down = iCommandPlane_HOTAS_ChinaHatAft, up = iCommandPlane_HOTAS_ChinaHatOff, name = _('HOTAS China Hat Aft'), category = _('HOTAS')},
{combos = {{key = 'JOY_BTN11'}}	,down = iCommandPlane_HOTAS_ChinaHatForward, up = iCommandPlane_HOTAS_ChinaHatOff, name = _('HOTAS China Hat Forward'), category = _('HOTAS')},

{combos = {{key = 'JOY_BTN15'}}	,down = iCommandPlane_HOTAS_LeftThrottleButton, up = iCommandPlane_HOTAS_LeftThrottleButton_Off, name = _('HOTAS Left Throttle Button'), category = _('HOTAS')},
...
{down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff, name = _('HOTAS Nosewheel Steering Button'), category = _('HOTAS')},

{combos = {{key = 'JOY_BTN8'}}	,down = iCommandPlane_HOTAS_SpeedBrakeSwitchAft, up = iCommandPlane_HOTAS_SpeedBrakeSwitchCenter, name = _('HOTAS Speed Brake Switch Aft'), category = _('HOTAS')},
{combos = {{key = 'JOY_BTN7'}}	,down = iCommandPlane_HOTAS_SpeedBrakeSwitchForward, up = iCommandPlane_HOTAS_SpeedBrakeSwitchCenter, name = _('HOTAS Speed Brake Switch Forward'), category = _('HOTAS')},

{combos = {{key = 'JOY_BTN14'}}	,down = iCommandPlane_HOTAS_PinkySwitchAft,     up = iCommandPlane_HOTAS_PinkySwitchCenter, name = _('HOTAS Pinky Switch : Aft<>Center'),     category = { _("Special For Joystick"), _('HOTAS')}},
{combos = {{key = 'JOY_BTN13'}}	,down = iCommandPlane_HOTAS_PinkySwitchForward, up = iCommandPlane_HOTAS_PinkySwitchCenter, name = _('HOTAS Pinky Switch : Forward<>Center'), category = { _("Special For Joystick"), _('HOTAS')}},

{combos = {{key = 'JOY_BTN3'}}	,down = iCommandPlane_HOTAS_MIC_SwitchUp,    up = iCommandPlane_HOTAS_MIC_SwitchOff, name = _('HOTAS MIC Switch Up'),    category = _('HOTAS')},
{combos = {{key = 'JOY_BTN5'}}	,down = iCommandPlane_HOTAS_MIC_SwitchDown,  up = iCommandPlane_HOTAS_MIC_SwitchOff, name = _('HOTAS MIC Switch Down'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN6'}}	,down = iCommandPlane_HOTAS_MIC_SwitchLeft,  up = iCommandPlane_HOTAS_MIC_SwitchOff, name = _('HOTAS MIC Switch Aft'),  category = _('HOTAS')},
{combos = {{key = 'JOY_BTN4'}}	,down = iCommandPlane_HOTAS_MIC_SwitchRight, up = iCommandPlane_HOTAS_MIC_SwitchOff, name = _('HOTAS MIC Switch Forward'), category = _('HOTAS')},
...
{combos = {{key = 'JOY_BTN22'}}	,down = iCommandPlane_FLAPS_UP, up = iCommandPlane_FLAPS_MNR_from_UP,name = _('Flaps : Up<>Center'), category = {_("Special For Joystick"), _('Systems')}},
{combos = {{key = 'JOY_BTN23'}}	,down = iCommandPlane_FLAPS_DN, up = iCommandPlane_FLAPS_MNR_from_DN,name = _('Flaps : Down<>Center'), category = {_("Special For Joystick"), _('Systems')}},
...
-- Autopilot
{combos = {{key = 'JOY_BTN26'}}	, down = iCommandPlaneAutopilot	   , up = iCommandPlaneAutopilot	  , name = _('LAAP Engage/Disengage')    , category = _('LASTE Control Panel')},
{combos = {{key = 'JOY_BTN27'}}	, down = iCommandPlaneStabPathHold , up = iCommand_LASTE_from_PATH_to_ALTHDG, name = _('LAAP Mode 3-pos Switch : PATH <> ALT/HDG'), category = { _("Special For Joystick"), _('LASTE Control Panel')}},
{combos = {{key = 'JOY_BTN28'}}	, down = iCommandPlaneStabHbarBank , up = iCommand_LASTE_from_ALT_to_ALTHDG , name = _('LAAP Mode 3-pos Switch : ALT <> ALT/HDG') , category = { _("Special For Joystick"), _('LASTE Control Panel')}},
{combos = {{key = 'JOY_BTN24'}}	, down = iCommandPlane_EAC_ARM     , up = iCommandPlane_EAC_OFF       , name = _('EAC 2-pos Switch : ARM<>OFF') 			  , category = { _("Special For Joystick"), _('LASTE Control Panel')}},
{combos = {{key = 'JOY_BTN25'}}	, down = iCommandPlane_RDR_ALTM_NRM, up = iCommandPlane_RDR_ALTM_DIS  , name = _('RDR ALTM 2-pos Switch : NORMAL<>DISABLE')  , category = { _("Special For Joystick"), _('LASTE Control Panel')}},

-- Engine Control Panel

{combos = {{key = 'JOY_BTN21'}}	, down = iCommandPlane_LG_WRN_Silence		, up = iCommandPlane_LG_WRN_Silence				, name = _('Landing Gear Warning Silence')			, category = _('Engine Control Panel')},
{combos = {{key = 'JOY_BTN20'}}	, down = iCommandPlane_APU_Start			, up = iCommandPlane_APU_Off	   				, name = _('APU Start 2-pos Switch : ON<>OFF')	, category = { _("Special For Joystick"),_('Engine Control Panel')}},

-- Left engine Motor/Norm/Ign switch
{combos = {{key = 'JOY_BTN31'}}	, down = iCommandPlane_L_ENG_OPER_Ign 		, up = iCommandPlane_L_ENG_OPER_Norm_from_Ign	, name = _('Left Engine Oper 3-pos Switch : IGN<>NORM')			, category = { _("Special For Joystick"),_('Engine Control Panel')}},
{combos = {{key = 'JOY_BTN18'}}	, down = iCommandPlane_L_ENG_OPER_Motor		, up = iCommandPlane_L_ENG_OPER_Norm_from_Motor	, name = _('Left Engine Oper 3-pos Switch : MOTOR<>NORM')			, category = { _("Special For Joystick"),_('Engine Control Panel')}},

-- Right engine Motor/Norm/Ign switch
{combos = {{key = 'JOY_BTN32'}}	, down = iCommandPlane_R_ENG_OPER_Ign  		, up = iCommandPlane_R_ENG_OPER_Norm_from_Ign	, name = _('Right Engine Oper 3-pos Switch : IGN<>NORM')			, category = { _("Special For Joystick"),_('Engine Control Panel')}},
{combos = {{key = 'JOY_BTN19'}}	, down = iCommandPlane_R_ENG_OPER_Motor		, up = iCommandPlane_R_ENG_OPER_Norm_from_Motor	, name = _('Right Engine Oper 3-pos Switch : MOTOR<>NORM')		, category = { _("Special For Joystick"),_('Engine Control Panel')}},

{combos = {{key = 'JOY_BTN16'}}	, down = iCommandPlane_L_ENG_FUEL_FLOW_Norm	, up = iCommandPlane_L_ENG_FUEL_FLOW_Override	, name = _('Left Engine Fuel Flow 2-pos Switch : NORM<>OVERRIDE')	, category = { _("Special For Joystick"),_('Engine Control Panel')}},
{combos = {{key = 'JOY_BTN17'}}	, down = iCommandPlane_R_ENG_FUEL_FLOW_Norm	, up = iCommandPlane_R_ENG_FUEL_FLOW_Override	, name = _('Right Engine Fuel Flow 2-pos Switch : NORM<>OVERRIDE')	, category = { _("Special For Joystick"),_('Engine Control Panel')}},
