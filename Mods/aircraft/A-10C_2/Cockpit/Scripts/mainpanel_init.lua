...
WheelBrakeRight					= CreateGauge()
WheelBrakeRight.arg_number		= 94
WheelBrakeRight.input			= {0, 1}
WheelBrakeRight.output			= {0, 1}
WheelBrakeRight.controller		= controllers.WheelBrakeRight

WheelBrakeLeft					= CreateGauge()
WheelBrakeLeft.arg_number		= 95
WheelBrakeLeft.input			= {0, 1}
WheelBrakeLeft.output			= {0, 1}
WheelBrakeLeft.controller		= controllers.WheelBrakeLeft
...
SAI_manual_pitch_adjustment.input	    = {-1.0, 1.0}
...
AirspeedNeedle.output		= {0.0, 0.048, 0.141, 0.238, 0.333, 0.425, 0.521, 0.616, 0.712, 0.807, 0.902, 0.997}
...
livery = find_custom_livery("A-10C_2","aged")
