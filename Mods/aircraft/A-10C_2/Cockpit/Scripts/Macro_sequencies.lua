...
VHF AM RADIO ON
--]]
{time = 24.926000,device = 55, action = 3043,value = 0.100000,message = _("VHF AM RADIO - TR + G"),message_timeout = std_message_timeout},
--[[
...
Canopy close
--]]
{time = 386.874000,device = 39,action = 3006,value = 0.000000,message = _("CANOPY - CLOSE"),message_timeout = std_message_timeout},
{time = 394.258000,device = 39,action = 3006,value = 0.500000},
-- Oxygen
...
{time = 52.918000,device = devices.VHF_AM_RADIO,	action = 3043,value = 0.0,message = _("VHF AM RADIO OFF"),message_timeout = std_message_timeout},
