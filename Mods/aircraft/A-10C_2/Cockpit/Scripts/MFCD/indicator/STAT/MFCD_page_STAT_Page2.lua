...
local TblIdxEnd = getTblIdx(LRU_HMCS)
...
Page2_DynamBackgndParam[getTblIdx(LRU_HMCS)] = 
	{{Color = MFCD_SOLID_RED, Ctrlr = {{"STAT_LRU_State_A10C_2", LRU_HMCS, STATUS_NC + STATUS_FAIL}} },
	 {Color = MFCD_SOLID_GREEN, Ctrlr = {{"STAT_LRU_State_A10C_2", LRU_HMCS, STATUS_VALID}} }}
...
-- A-10C II specific
Page2_SecondColDynamTextParam[getTblIdx(LRU_HMCS)] =
	{{Value = "NC", Ctrlr = {{"STAT_LRU_State_A10C_2", LRU_HMCS, STATUS_NC}} },
	 {Value = "FAIL", Ctrlr = {{"STAT_LRU_State_A10C_2", LRU_HMCS, STATUS_FAIL}} },
	 {Value = "VALID", Ctrlr = {{"STAT_LRU_State_A10C_2", LRU_HMCS, STATUS_VALID}} }}
