...
-- TODO: osb 2 is not empty for three-pages STAT
add_dummy_boxes({2, 4})

-- HMCS label

Label_OSB3_symbol						= CreateElement "ceStringPoly"
Label_OSB3_symbol.name					= "Label_OSB3_symbol"
Label_OSB3_symbol.alignment				= "CenterTop"
Label_OSB3_symbol.value					= BRANCH_L
Label_OSB3_symbol.material				= font_MFCD
Label_OSB3_symbol.stringdefs			= txt_labels_font
Label_OSB3_symbol.UseBackground			= false
Label_OSB3_symbol.BackgroundMaterial	= MFCD_SOLID_BLACK
shift_button_pos(Label_OSB3_symbol, 3, -27)
...
Label_OSB3.value					= "HMCS"
Label_OSB3.stringdefs				= txt_labels_font
shift_button_pos(Label_OSB3, 3, 0)
Add(Label_OSB3)
use_mipfilter(Label_OSB3)

addOSB_Box(3, {Label_OSB3_symbol, Label_OSB3})
add_osb_static_hint(3, _("Go to HMCS Page"))
