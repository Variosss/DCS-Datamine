...
InventorySettingsText.value				= "BDU-56"
...
Label_OSB7.controllers				= {{"DSMS_inventory_settings_lsr_avail"}}
...
Label_OSB7_text.formats				= {"LSR CODE\n%d"}
...
Label_OSB7_text.controllers			= {{"DSMS_inventory_settings_lsr_avail"}, {"DSMS_inventory_settings_lsr_code", 0}}
Add(Label_OSB7_text)
use_mipfilter(Label_OSB7_text)

addOSB_Box(7, {Label_OSB7, Label_OSB7_text})
add_osb_hint_controllers(7, _("Laser code"), {{"DSMS_inventory_settings_lsr_avail"}})
...
addOSB_Box(8, {Label_OSB8, Label_OSB8_text, Label_OSB8_text1})
...
Label_OSB16.controllers				= {{"DSMS_inventory_series_avail_bdu56"}}
...
Label_OSB16_pod.formats				= {"SERIES\n%s"}
...
Label_OSB16_pod.controllers			= {{"DSMS_inventory_series", 0}}
