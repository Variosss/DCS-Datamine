...
InventorySettingsText.value				= "GBU-10"
...
Label_OSB7_text.controllers			= {{"DSMS_inventory_settings_lsr_code", 0}}
Add(Label_OSB7_text)
use_mipfilter(Label_OSB7_text)

addOSB_Box(7, {Label_OSB7, Label_OSB7_text})
add_osb_static_hint(7, _("Laser code"))
...
add_osb_static_hint(16, _("Select GBU 10 type"))
