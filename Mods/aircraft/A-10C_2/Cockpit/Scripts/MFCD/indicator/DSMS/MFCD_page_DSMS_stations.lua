...
MavStat[3].controllers				= {{"DSMS_maverick_status_A10C_2", StoreIndexes[3], flash_time}, {"DSMS_store_color", StoreIndexes[3]}}
...
MavStat[9].controllers				= {{"DSMS_maverick_status_A10C_2", StoreIndexes[9], flash_time}, {"DSMS_store_color", StoreIndexes[9]}}
...
for i = 2, 10 do
	if i ~= 5 and i ~= 6 and i ~= 7 then
		add_rockets_param(i, "RocketParam" .. i, RocketParamStrFormats, {{"DSMS_station_is_rocket", StoreIndexes[i]}, {"DSMS_store_color", StoreIndexes[i]}, {"DSMS_store_rocket_param_A10C_2", StoreIndexes[i], flash_time}})
	end
end
...
for i = 3, 9 do
	add_IAM_status(i, "IAM_status" .. i, IAM_str_formats, {{"DSMS_store_is_IAM", StoreIndexes[i]}, {"DSMS_store_IAM_status_A10C_2", StoreIndexes[i], flash_time}, {"DSMS_store_color", StoreIndexes[i]}})
end
