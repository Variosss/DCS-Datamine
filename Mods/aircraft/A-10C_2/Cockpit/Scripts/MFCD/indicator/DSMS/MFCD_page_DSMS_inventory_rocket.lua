...
Label_OSB18_Symb.stringdefs				= predefined_fonts[1]
Label_OSB18_Symb.controllers			= {{"DSMS_inventory_rockets_lsr_code_avail"}}
...
Label_OSB18.formats						= {"LSR CODE\n%d"}
Label_OSB18.material					= font_MFCD
Label_OSB18.stringdefs					= predefined_fonts[1]
Label_OSB18.parent_element				= Label_OSB18_Symb.name 
Label_OSB18.init_pos					= {3*OSB_label_spacing,0,0}
Label_OSB18.controllers					= {{"DSMS_inventory_settings_lsr_code", 0}}
Add(Label_OSB18)
use_mipfilter(Label_OSB18)

addOSB_Box(18, {Label_OSB18_Symb, Label_OSB18})
add_osb_hint_controllers(18, _("Laser code"), {{"DSMS_inventory_rockets_lsr_code_avail"}})
...
LabelOSB209.value						= "M-151L\nAPKWS"
LabelOSB209.controllers					= {{"DSMS_inventory_rocket_name", 1003}}
Add(LabelOSB209)
use_mipfilter(LabelOSB209)

LabelOSB2010							= Copy(LabelOSB200)
LabelOSB2010.value						= "M-282L\nAPKWS"
LabelOSB2010.controllers				= {{"DSMS_inventory_rocket_name", 1004}}
Add(LabelOSB2010)
use_mipfilter(LabelOSB2010)

addOSB_Box(20, {Label_OSB20_Symb, LabelOSB200, LabelOSB201, LabelOSB202, LabelOSB203, LabelOSB204, LabelOSB205, LabelOSB206, LabelOSB207, LabelOSB208, LabelOSB209, LabelOSB2010})
