...
--Label_OSB6.controllers			= {{"DSMS_profile_is_LJDAM", 0}, {"DSMS_profile_settings_auto_ls"}}
...
Label_OSB6_text1.controllers		= {{"DSMS_profile_is_IAM"}, {"DSMS_profile_patt_az"}}
...
addOSB_Box(6, {Label_OSB6, Label_OSB6_text, Label_OSB6_Symb, Label_OSB6_text1})
--add_osb_hint_controllers(6, _("Pattern azimuth, no function"), {{"DSMS_profile_is_IAM"}}) 
add_osb_hint_format_controllers(6,
								{_("Laser auto-fire enabled"), _("Pattern azimuth, no function")}, 
								{{"DSMS_profile_settings_osb_06_hint_A10C_2"}})
--]]
...
Label_OSB7_text1.controllers		= {{"DSMS_profile_is_IAM"}, {"DSMS_profile_imp_az"}}
...
add_osb_hint_format_controllers(7,
								{_("Horizontal offset in mils"), _("Impact azimuth, no function")}, 
								{{"DSMS_profile_settings_osb_07_hint_A10C_2"}})
...
Label_OSB8_text1.controllers		= {{"DSMS_profile_is_IAM"}, {"DSMS_profile_imp_ang"}}
...
--add_osb_hint_controllers(8, _(""), {{"DSMS_profile_is_IAM"}})
add_osb_hint_format_controllers(8,
								{_("Vertical offset in mils"), _("Impact angle, no function")}, 
								{{"DSMS_profile_settings_osb_08_hint_A10C_2"}})
...
--[[
Label_OSB16_3						= CreateElement "ceStringPoly"
Label_OSB16_3.name					= "Label_OSB16_3"
Label_OSB16_3.alignment				= "CenterCenter"
Label_OSB16_3.value					= ROTARY
Label_OSB16_3.material				= font_MFCD
Label_OSB16_3.stringdefs			= predefined_fonts[1]
Label_OSB16_3.UseBackground			= false
Label_OSB16_3.BackgroundMaterial	= MFCD_SOLID_BLACK
Label_OSB16_3.controllers       	= {{"DSMS_profile_is_LJDAM", 1}, {"DSMS_profile_settings_auto_ls"}}
shift_button_pos(Label_OSB16_3,16,-OSB_label_spacing,0)
Add(Label_OSB16_3)
use_mipfilter(Label_OSB16_3)

Label_OSB16_3_text					= CreateElement "ceStringPoly"
Label_OSB16_3_text.name				= "LABEL_OSB16_3_TEXT"
Label_OSB16_3_text.alignment		= "LeftCenter"
Label_OSB16_3_text.formats			= {"AUTO LS\n%s"}
Label_OSB16_3_text.material			= font_MFCD
Label_OSB16_3_text.stringdefs		= predefined_fonts[1]
Label_OSB16_3_text.UseBackground	= false
Label_OSB16_3_text.BackgroundMaterial= MFCD_SOLID_BLACK
Label_OSB16_3_text.parent_element	= Label_OSB16_3.name 
Label_OSB16_3_text.init_pos			= {OSB_label_spacing,0,0}
Label_OSB16_3_text.controllers		= {{"DSMS_profile_settings_auto_ls"}, {"DSMS_profile_settings_auto_ls_data"}}
Add(Label_OSB16_3_text)
use_mipfilter(Label_OSB16_3_text)

addOSB_Box(16, {Label_OSB16, Label_OSB16_text, 
				Label_OSB16_1, Label_OSB16_1_text,
				Label_OSB16_2, Label_OSB16_2_text,
				Label_OSB16_3, Label_OSB16_3_text})
...
add_osb_hint_format_controllers(16, 
								{_("Desired height over target at mid-burn"), _("LGB solution"), _("Low Drag Time of Fall in seconds"),
								 _("Laser auto-fire enabled")}, 
								{{"DSMS_profile_settings_osb_16_hint_A10C_2"}})
--]]
...
add_osb_hint_format_controllers(17, 
								{_("Minimum time of flight in seconds"), _("Laser on time, seconds"), _("High Drag Time of Fall Time in seconds"), _("Drag (No function)")}, 
...
addOSB_Box(19, {Label_OSB19, Label_OSB19_text, Label_OSB19_1_txt, Label_OSB19_1_text})
...
addOSB_Box(20, {Label_OSB20, Label_OSB20_text, Label_OSB20_1_txt, Label_OSB20_1_text})
