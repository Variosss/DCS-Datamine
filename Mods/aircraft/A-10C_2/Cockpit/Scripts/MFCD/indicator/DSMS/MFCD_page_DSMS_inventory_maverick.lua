...
Label_OSB3.controllers				= {{"DSMS_inventory_missile_lsr_code_avail"}}
shift_button_pos(Label_OSB3, 3, -29)
Add(Label_OSB3)
use_mipfilter(Label_OSB3)

Label_OSB3_text						= CreateElement "ceStringPoly"
Label_OSB3_text.name				= "Label_OSB3_text"
Label_OSB3_text.alignment			= "CenterTop"
Label_OSB3_text.formats				= {"CODE\n%d"}
Label_OSB3_text.material			= font_MFCD
Label_OSB3_text.stringdefs			= predefined_fonts[1]
Label_OSB3_text.UseBackground		= false
Label_OSB3_text.BackgroundMaterial	= MFCD_SOLID_BLACK
shift_button_pos(Label_OSB3_text, 3)
Label_OSB3_text.controllers			= {{"DSMS_inventory_missile_lsr_code_avail"}, {"DSMS_inventory_settings_lsr_code", 0}}
Add(Label_OSB3_text)
use_mipfilter(Label_OSB3_text)

addOSB_Box(3, {Label_OSB3, Label_OSB3_text})
add_osb_hint_controllers(3, _("Laser code"), {{"DSMS_inventory_missile_lsr_code_avail"}})
...
Label_OSB16_AGM							= CreateElement "ceStringPoly"
Label_OSB16_AGM.name					= "Label_OSB16_AGM"
Label_OSB16_AGM.alignment				= "LeftCenter"
Label_OSB16_AGM.value					= SYS_ACTION .. "AGM-65L"
Label_OSB16_AGM.material				= font_MFCD
Label_OSB16_AGM.stringdefs				= txt_labels_font
Label_OSB16_AGM.UseBackground			= false
Label_OSB16_AGM.BackgroundMaterial		= MFCD_SOLID_BLACK
Label_OSB16_AGM.controllers				= {{"DSMS_inventory_mav_agm", 1}}
shift_button_pos(Label_OSB16_AGM,16,1*OSB_label_spacing,0)
Add(Label_OSB16_AGM)
use_mipfilter(Label_OSB16_AGM)

Label_OSB16_TGM							= Copy(Label_OSB16_AGM)
Label_OSB16_TGM.value					= SYS_ACTION .. "TGM-65L"
Label_OSB16_TGM.controllers				= {{"DSMS_inventory_mav_agm", 0}}
Add(Label_OSB16_TGM)
use_mipfilter(Label_OSB16_TGM)

addOSB_Box(16, {Label_OSB16_AGM, Label_OSB16_TGM})
add_osb_hint_format_controllers(16, {_("AGM-65L select"), _("TGM-65L select")}, {{"DSMS_inventory_mav_agm_hint"}})
