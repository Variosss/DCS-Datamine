...
declare_loadout({
	...
	displayName		= _("KAB-1500Kr - 1500kg TV Guided Bomb"),
...
declare_loadout({
	...
	displayName		= _("KAB-1500LG-Pr - 1500kg Laser Guided Penetrator Bomb"),
...
declare_loadout({
	...
	Cx_pil			= KAB_500S.Cx,
	Picture			= "kab500s.png",
	displayName		= _("KAB-500S - 500kg GPS Guided Bomb"),
