...
Type200 = {
    ...
    targeting_data = { -- TODO
        ...
        chute_open_time = 1.5,
        chute_cut_time  = 7.5, -- does not correspond to control's values in order to compensate the lack of accounting for engine in aiming calculations
        data = {
