        ...
        pylon(2, 0, -1.982, -0.207, -2.867,{ use_full_connector_position=true,connector = "Pylon2", arg = 309, arg_value = 0.0 },
            {
				...
				pylon_loadout(id_AIM_9B, 0.15, nil,	nil, 		{ 6 }),		-- AIM-9B
				pylon_loadout(id_AIM_9J, 0.15, nil,	nil,		{ 6 }), 	-- AIM-9J
				pylon_loadout(id_AIM_9JULI, 0.15, nil, nil,		{ 6 }),	-- AIM-9JULI				
        ...
        pylon(6, 0, -1.982, -0.207, 2.867,{ use_full_connector_position=true,connector = "Pylon6", arg = 313, arg_value = 0.0 },
            {
				...
				pylon_loadout(id_AIM_9B, 0.15, nil,	nil, 		{ 2 }),		-- AIM-9B
				pylon_loadout(id_AIM_9J, 0.15, nil,	nil,		{ 2 }), 	-- AIM-9J
				pylon_loadout(id_AIM_9JULI, 0.15, nil, nil,		{ 2 }),	-- AIM-9JULI					
