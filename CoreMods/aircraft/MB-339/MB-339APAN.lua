...
MB_339APAN =  {
	...
	Name 					=   'MB-339APAN',
	DisplayName				= _('MB-339A/PAN'),
	ViewSettings 			= ViewSettings,
	SnapViews	 			= SnapViews,
-----------------------------------------------------------------------------------------------	
	Picture 				= "MB-339APAN.png",
	...
	Pylons =     {			-- 3DS: x,z,y  x=Forward -x=Back z=Up -z=Down y=Sx -yDx
		...
		pylon(4, 0, -0.423, -0.606, -2.799,
            ...
            {--pyl inner max allowed weight: 1000lbs - 454kgs
				{CLSID = "<CLEAN>", 								arg_value = 1, add_mass = -23, cx_gain = -0.0003 },  --NO PYLON
                {CLSID = "{COLOR-TANK}",							required ={{station =7, loadout={"{WHITE-TANK}"}}}, cx_gain = 0.0003,			arg_value = 0.4},	-- OIL TANK			
		}
		),
		...
		pylon(5, 0, -8.0, 0.05, 0,
            ...
            {
                {CLSID = "{SMOKE-RED-MB339}",		    required ={{station =4, loadout={"{COLOR-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-RED-MB339} SMOKE POD
                {CLSID = "{SMOKE-GREEN-MB339}",		    required ={{station =4, loadout={"{COLOR-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-GREEN-MB339} SMOKE POD
				{CLSID = "{SMOKE-YELLOW-MB339}",		required ={{station =4, loadout={"{COLOR-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-YELLOW-MB339} SMOKE POD
				{CLSID = "{SMOKE-ORANGE-MB339}",		required ={{station =4, loadout={"{COLOR-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-ORANGE-MB339} SMOKE POD
				{CLSID = "{SMOKE-BLACK-MB339}",			required ={{station =4, loadout={"{COLOR-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-BLACK-MB339} SMOKE POD				
            }
        ),
		...
		pylon(6, 0, -8.0, 0.05, 0,
            ...
            {
                {CLSID = "{SMOKE-WHITE-MB339}",		    required ={{station =7, loadout={"{WHITE-TANK}"}}},	arg_value = 0.0},				-- {SMOKE-WHITE-MB339} SMOKE POD
            }
        ),
		...
		pylon(7, 0, -0.423, -0.606, 2.799,
            ...
            {
				{CLSID = "<CLEAN>", arg_value = 1, add_mass = -23, cx_gain = -0.0003 },  --NO PYLON
                {CLSID = "{WHITE-TANK}",							required ={{station =4, loadout={"{COLOR-TANK}"}}},	cx_gain = 0.0003,			arg_value = 0.4},	-- OIL TANK				
			}
        ),
...
--=======================================================================================================
	AddPropAircraft = {
		{ id = "SoloFlight" 			, control = 'checkbox' , label = _('Solo Flight')			   , defValue = true, weightWhenOn = -85},
		...
		{ id = "UnlimitedSmoke" , control = 'checkbox', label = _('Unlimited Smoke'), defValue = false},		
	},   
}

add_aircraft(MB_339APAN)