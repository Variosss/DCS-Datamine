...
GT.visual.shape = "teplowoz"
GT.visual.shape_dstr = "teplowoz_p_1"
...
GT.visual.min_time_agony = 50;
GT.visual.max_time_agony = 250;
GT.visual.agony_explosion_size = 15;

GT.Name = "Locomotive"
GT.DisplayName = _("Loco CHME3T")
GT.DisplayNameShort = _("Loco3T")
GT.Rate = 10
