...
GT.visual.shape = "wagon-cisterna_yellow"
...
GT.Name = "Coach a tank yellow"
GT.DisplayName = _("Tank Car yellow") --Coach a tank yellow
...
GT.attribute = {wsType_Ground, wsType_Moving, wsType_Civil, wsTypeWCisternaYELLOW,
				"Trucks",
				};
