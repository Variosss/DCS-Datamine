...
GT.Stations = CVN_7X_STATIONS(72)
...
GT.DM = {
	...
	{ area_name = "CENTER_R_02", 			area_arg = 72, area_life = 150},
	...
	{ area_name = "BACK_72", 				area_arg = 78, area_life = 150},
	...
	{ area_name = "PALUBA_MIDLE_02",		area_arg = 81, area_life = 300, armour = {width = 0.030}, area_fire = { connector = "FIRE_PALUBA_MIDLE_02", size = 0.8}, belongsToRunway = true},
	...
	{ area_name = "Col_Island_72_Front", 	area_arg = 83, area_life = 75},
	{ area_name = "Col_Island_72_R", 		area_arg = 84, area_life = 75, area_fire = { connector = "FIRE_RUBKA_72_02", size = 0.3}},
	{ area_name = "Col_Island_72_Back", 	area_arg = 85, area_life = 75},
	{ area_name = "Col_Island_72_L", 		area_arg = 86, area_life = 75, area_fire = { connector = "FIRE_RUBKA_72_04", size = 0.3}},
	{ area_name = "Col_Island_72_Top", 		area_arg = 87, area_life = 75, area_fire = { connector = "FIRE_RUBKA_72_05", size = 0.4}},
	
	{ area_name = "MACHTA_72", 				area_arg = 88, area_life = 50},
	{ area_name = "TOWER_72", 				area_arg = 89, area_life = 80},
	...
	{ area_name = "ZA_BR",					area_arg = 102, area_life = 2},
	...
	{area_name = "Rad_72_7", 				area_life = 2,},
	{area_name = "Rad_72_3", 				area_life = 2,},
	{area_name = "Rad_72_15", 				area_life = 2,},	
}
...
GT.WS[ws].area = 'ZA_BR'
GT.WS[ws].angles = {
					 {math.rad(-76), math.rad(-80), math.rad(-5), math.rad(23)},
					 {math.rad(-80), math.rad(100), math.rad(-5), math.rad(85)},
				   }
GT.WS[ws].center = 'CENTER_TOWER_ZA_BR_72'
GT.WS[ws].drawArgument1 = 21
GT.WS[ws].drawArgument2 = 22
GT.WS[ws].reference_angle_Y = math.rad(180)
GT.WS[ws].LN[1].BR[1].connector_name = 'POINT_GUN_ZA_BR_72';
...
GT.WS[ws].area = 'Rad_72_3'
GT.WS[ws].center = 'CENTER_RADAR_72_01'
GT.WS[ws].drawArgument1 = 6
GT.WS[ws].drawArgument2 = 7
GT.WS[ws].reference_angle_Y = math.rad(-90)
GT.WS[ws].angles = {
						{math.rad(60), math.rad(-170), math.rad(-10), math.rad(80)},
					}
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT.WS[first_MK95_tracker_id]);
GT.WS[ws].area = 'Rad_72_15'
GT.WS[ws].center = 'CENTER_RADAR_72_10'
GT.WS[ws].drawArgument1 = 10
GT.WS[ws].drawArgument2 = 11
GT.WS[ws].reference_angle_Y = math.rad(-90)
GT.WS[ws].angles = { {math.rad(-5), math.rad(120), math.rad(-10), math.rad(80)} }
table.insert(MK95_TRACKERS, {{'self', ws}})
-- 7
...
GT.Name = "CVN_72"
GT.DisplayName = _("CVN-72 Abraham Lincoln")
GT.DisplayNameShort = _("CVN-72")
GT.Rate = 5500.000000
