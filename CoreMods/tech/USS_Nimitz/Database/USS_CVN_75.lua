...
GT.Stations = CVN_7X_STATIONS(75)
...
GT.DM = {
	...
	{ area_name = "BACK_75", 				area_arg = 78, area_life = 150},
	...
	{ area_name = "Col_Island_75_Front", 	area_arg = 83, area_life = 75},
	{ area_name = "Col_Island_75_R", 		area_arg = 84, area_life = 75, area_fire = { connector = "FIRE_RUBKA_75_02", size = 0.3}},
	{ area_name = "Col_Island_75_Back", 	area_arg = 85, area_life = 75},
	{ area_name = "Col_Island_75_L", 		area_arg = 86, area_life = 75, area_fire = { connector = "FIRE_RUBKA_75_04", size = 0.3}},
	{ area_name = "Col_Island_75_Top", 		area_arg = 87, area_life = 75, area_fire = { connector = "FIRE_RUBKA_75_05", size = 0.4}},
	
	{ area_name = "MACHTA_75", 				area_arg = 88, area_life = 50},
	{ area_name = "TOWER_75", 				area_arg = 89, area_life = 80},
	...
	{area_name = "Rad_75_3", 				area_life = 2,},
	{area_name = "Rad_75_12", 				area_life = 2,},
	{area_name = "Rad_75_13", 				area_life = 2,},
	{area_name = "Rad_75_15", 				area_life = 2,},
}
-- weapon systems
GT.WS = {}
...
GT.WS[ws] = {
	...
	area = 'Rad_75_12',
	center = 'CENTER_RADAR_75_08',
	drawArgument1 = 8,
	drawArgument2 = 9,
	reference_angle_Y = math.rad(-90),
	angles = { 
				{math.rad(-15), math.rad(-170), math.rad(-10), math.rad(80)}
			},
	LN = {
		[1] = {
			type = 102,
...
GT.WS[ws].area = 'Rad_75_3'
GT.WS[ws].center = 'CENTER_RADAR_75_01'
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT.WS[first_MK95_tracker_id]);
GT.WS[ws].area = 'Rad_75_13'
GT.WS[ws].center = 'CENTER_RADAR_75_09'
GT.WS[ws].drawArgument1 = 10
GT.WS[ws].drawArgument2 = 11
GT.WS[ws].reference_angle_Y = math.rad(90)
GT.WS[ws].angles = { {math.rad(-155), math.rad(13.5), math.rad(-10), math.rad(80)} }
table.insert(MK95_TRACKERS, {{'self', ws}})
-- 6
ws = GT_t.inc_ws();
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT.WS[first_MK95_tracker_id]);
GT.WS[ws].area = 'Rad_75_15'
GT.WS[ws].center = 'CENTER_RADAR_75_11'
...
GT.WS[ws].angles = {
					 ...
					 {math.rad(40), math.rad(5), math.rad(25), math.rad(80)},
					 {math.rad(5), math.rad(-170), math.rad(-5), math.rad(80)},
				   }
...
GT.Name = "CVN_75"
GT.DisplayName = _("CVN-75 Harry S. Truman")
GT.DisplayNameShort = _("CVN-75")
GT.Rate = 5500.000000
