...
GT.Stations = CVN_7X_STATIONS(74)
...
GT.DM = {
	...
	{ area_name = "BACK_74", 				area_arg = 78, area_life = 150},
	...
	{ area_name = "Col_Island_74_Front", 	area_arg = 83, area_life = 75},
	{ area_name = "Col_Island_74_R", 		area_arg = 84, area_life = 75, area_fire = { connector = "FIRE_RUBKA_74_02", size = 0.3}},
	{ area_name = "Col_Island_74_Back", 	area_arg = 85, area_life = 75},
	{ area_name = "Col_Island_74_L", 		area_arg = 86, area_life = 75, area_fire = { connector = "FIRE_RUBKA_74_04", size = 0.3}},
	{ area_name = "Col_Island_74_Top", 		area_arg = 87, area_life = 75, area_fire = { connector = "FIRE_RUBKA_74_05", size = 0.4}},
	
	{ area_name = "MACHTA_74", 				area_arg = 88, area_life = 50},
	{ area_name = "TOWER_74", 				area_arg = 89, area_life = 80},
	...
	{area_name = "Rad_74_4", 				area_life = 2,},
	{area_name = "Rad_74_3", 				area_life = 2,},
	{area_name = "Rad_74_11", 				area_life = 2,},
	{area_name = "Rad_74_12", 				area_life = 2,},
	{area_name = "Rad_74_13", 				area_life = 2,},
}
...
GT.WS[ws].center = 'CENTER_TOWER_ZA_BR_74'
GT.WS[ws].drawArgument1 = 21
GT.WS[ws].drawArgument2 = 22
GT.WS[ws].reference_angle_Y = math.rad(180)
GT.WS[ws].LN[1].BR[1].connector_name = 'POINT_GUN_ZA_BR_74';
...
GT.WS[ws].center = 'CENTER_RADAR_74_01'
GT.WS[ws].drawArgument1 = 6
GT.WS[ws].drawArgument2 = 7
GT.WS[ws].reference_angle_Y = math.rad(-90)
GT.WS[ws].angles = {
						{math.rad(90), math.rad(-180), math.rad(-90), math.rad(80)},
					}
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT.WS[first_MK95_tracker_id]);
GT.WS[ws].area = 'Rad_74_13'
GT.WS[ws].center = 'CENTER_RADAR_74_11'
GT.WS[ws].drawArgument1 = 12
GT.WS[ws].drawArgument2 = 13
GT.WS[ws].reference_angle_Y = math.rad(-90)
GT.WS[ws].angles = { {math.rad(-5), math.rad(120), math.rad(-90), math.rad(80)} }
table.insert(MK95_TRACKERS, {{'self', ws}})
--7 Mk 95 radar BL
ws = GT_t.inc_ws();
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT.WS[first_MK95_tracker_id]);
GT.WS[ws].area = 'Rad_74_12'
GT.WS[ws].center = 'CENTER_RADAR_74_10'
GT.WS[ws].drawArgument1 = 10
GT.WS[ws].drawArgument2 = 11
GT.WS[ws].reference_angle_Y = math.rad(90)
GT.WS[ws].angles = { {math.rad(-170), math.rad(20), math.rad(-90), math.rad(80)} }
table.insert(MK95_TRACKERS, {{'self', ws}})
...
GT.Name = "Stennis"
GT.DisplayName = _("CVN-74 John C. Stennis")
GT.DisplayNameShort = _("CVN-74")
GT.Rate = 5500.000000
