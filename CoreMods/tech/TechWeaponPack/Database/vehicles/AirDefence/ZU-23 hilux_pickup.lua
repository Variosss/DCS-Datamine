-- TT HL Pickup with ZU-23

GT = {};
GT_t.ws = 0;
set_recursive_metatable(GT, GT_t.generic_wheel_vehicle);
set_recursive_metatable(GT.chassis, GT_t.CH_t.hilux_pickup);
GT.chassis.mass = GT.chassis.mass + 950;  --2610=1660+950kg Zu-23

GT.visual.shape = "ttHL-zu23";
GT.visual.shape_dstr = "ttHL_p_1";

GT.encyclopediaAnimation = { 
	args = {
		[1] = 0.111, -- cannon elevation 10 degrees
	}		
}
...
GT.visual.IR = { coeffs = {GT_t.IR_COEFFS_ENGINE_APC, GT_t.IR_COEFFS_WHEELS_Car, GT_t.IR_COEFFS_30mm, IR_COEFFS_BODY, {0.25, 0.25/1050}}}
...
GT.WS[ws].angles = {
					{math.rad(35.1), math.rad(-35.1), math.rad(10), math.rad(88)}, -- over hood
					{math.rad(-35.1), math.rad(35.1), math.rad(-14), math.rad(88)},  -- main sector
					};
...
GT.Name = "HL_ZU-23"
GT.DisplayName = _("SPAAA HL with ZU-23")
GT.DisplayNameShort = _("HL ZU-23")
GT.Rate = 6
GT.Crew = 2
