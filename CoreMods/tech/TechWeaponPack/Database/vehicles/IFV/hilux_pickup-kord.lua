...
GT.chassis.mass = GT.chassis.mass + 80;   --1740=1660+80kg KORD

GT.visual.shape = "ttHL-kord";
...
GT.WS[ws].angles = {
					 {math.rad(24), math.rad(-24), math.rad(-6.5), math.rad(80)}, -- roof sector
                    {math.rad(-24), math.rad(24), math.rad(-23), math.rad(80)},	-- main
					};
...
--------------------------------------
GT.Name = "HL_KORD";
GT.DisplayName = _("Scout HL with KORD 12.7mm");
GT.DisplayNameShort = _("HL KORD");
GT.Rate = 6;
GT.Crew = 2;
