...
GT.chassis.mass = GT.chassis.mass + 80;	 --2155=2075+80kg DShK

GT.visual.shape = "tt70-dshk";
...
GT.WS[ws].angles = {
                    {math.rad(26.3), math.rad(-26.3), math.rad(0), math.rad(80)},		-- roof sector
                    {math.rad(-26.3), math.rad(26.3), math.rad(-18.5), math.rad(80)},	-- main
					};
...
GT.Name = "tt_DSHK";
GT.DisplayName = _("Scout LC with DSHK 12.7mm");
GT.DisplayNameShort = _("LC DSHK");
GT.Rate = 6;
GT.Crew = 2;
