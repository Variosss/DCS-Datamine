...
GT.chassis.mass = GT.chassis.mass + 80;	 --2155=2075+80kg KORD

GT.visual.shape = "tt70-kord"
...
GT.WS[ws].angles = {
                    ...
                    {math.rad(-26.3), math.rad(26.3), math.rad(-21), math.rad(80)}, -- main
					};
...
--------------------
GT.Name = "tt_KORD";
GT.DisplayName = _("Scout LC with KORD 12.7mm");
GT.DisplayNameShort = _("LC KORD");
GT.Rate = 6;
GT.Crew = 2;
