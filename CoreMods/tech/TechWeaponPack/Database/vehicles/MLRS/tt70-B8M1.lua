...
GT.chassis.mass = GT.chassis.mass + 470; 	--2545=2075+470kg B8M1 S-8OF

GT.visual.shape = "tt70-B8M1";
...
GT.WS[ws] = {};
local testWS = GT_t.WS_t.MLRS_B8N1
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.MLRS_B8N1);
GT.WS[ws].pos = {-0.7, 2.03, 0.0}
...
GT.Name = "tt_B8M1";
GT.DisplayName = _("MLRS LC with B8M1 80mm");
GT.DisplayNameShort = _("LC B8M1")
GT.Rate = 6;
GT.Crew = 2;
