...
GT.visual.shape = "leopard-2";	-- Leopard-2A6 actualy. Difference from A5 in cannon and smoke grenades.
...
GT.WS[ws].cockpit = { "EMES-15_2A6/EMES-15", {0.0, 0.0, 0.0 }, };
GT.WS[ws].angles = {
...
__LN.PL[1].shell_name = {"DM12_L55_120mm_HEAT_MP_T"};
__LN.combatRange = 800
__LN.PL[1].ammo_capacity = 6;
__LN.PL[1].reload_time = 15 * 6
__LN.PL[1].shot_delay = 6
__LN.PL[2].shell_name = {"DM12_L55_120mm_HEAT_MP_T"};
