...
GT.chassis.life 				= 3
GT.chassis.mass 				= 13600
GT.chassis.length 				= 7.650
GT.chassis.width 				= 2.9
GT.chassis.max_road_velocity 	= 25
GT.chassis.canSwim 				= true
GT.chassis.waterline_level 		= 1.1
GT.chassis.max_slope 			= 0.47
GT.chassis.engine_power 		= 260
