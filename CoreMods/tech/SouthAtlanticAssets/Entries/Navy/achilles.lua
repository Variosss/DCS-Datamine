-- MOD for DCS WORLD 
-- Leander Class Frigate - Achilles.
...
GT.visual = {};
GT.visual.shape = "leander-gun-achilles";
...
GT.WS[ws].angles = {
					 {math.rad(-90), math.rad(30), math.rad(0), math.rad(89)},
					 {math.rad(-40), math.rad(30), math.rad(75), math.rad(89)},
					 --{math.rad(-90), math.rad(-180), math.rad(0), math.rad(89)},
					 --{math.rad(-180), math.rad(-30), math.rad(0), math.rad(89)},
					 --{math.rad(180), math.rad(30), math.rad(0), math.rad(89)},
				   }
GT.WS[ws].reference_angle_Z = math.rad(89)
GT.WS[ws].LN[1].BR = {
...
GT.Name = "leander-gun-achilles";
GT.DisplayName = _("HMS Achilles (F12)");
GT.Rate = 4000;
