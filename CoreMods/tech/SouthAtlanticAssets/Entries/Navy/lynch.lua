-- MOD for DCS WORLD 
-- Leander/Condell Class Frigate - PFG-07 Almirante Lynch.
...
GT.visual = {};
GT.visual.shape = "leander-gun-lynch";
...
GT.Name = "leander-gun-lynch";
GT.DisplayName = _("CNS Almirante Lynch (PFG-07)");
GT.Rate = 4000;
