livery = {
	{"f15nose", 0 ,"f15_nose3",true};
	{"f15nose", 3 ,"f15_decol_empty",true};
	{"f15bottom", 0 ,"f15_bottom3",true};
	{"f15bottom", 3 ,"f15_decol_empty",true};
	{"f15centr", 0 ,"f15_centr3",true};
	{"f15wingl", 0 ,"f15_wing_l3",true};
	{"f15wingl", 3 ,"f15_decol_empty",true};
	{"f15wingr", 0 ,"f15_wing_r3",true};
	{"f15stab", 0 ,"f15_stab_v3",true};
