livery = {
	{"f15nose", 0 ,"f15_nose1",true};
	{"f15nose", 3 ,"f15_decol1",true};
	{"f15bottom", 0 ,"f15_bottom1",true};
	{"f15bottom", 3 ,"f15_decol1",true};
	{"f15centr", 0 ,"f15_centr1",true};
	{"f15wingl", 0 ,"f15_wing_l1",true};
	{"f15wingl", 3 ,"f15_decol1",true};
	{"f15wingr", 0 ,"f15_wing_r1",true};
	{"f15stab", 0 ,"f15_stab_v1",true};
