distance =
{
	...
	uniqueSceneFarDistance = 30000.0;
	smokesSceneFarDistance = 30000.0;
...
distanceBlend = 
{
	...
	waterNearDistance = 40000.0;
	waterFarDistance  = 80000.0;
	townLightNearDistance  = 10000.0;
	townLightFarDistance  = 20000.0;
	subforest = {20000, 60000};
	beach = {30000, 60000};
	road = {30000, 60000};
}
...
district =
{
	...
	farDistance = 50000.0;
	farFullRenderDistance = 30000.0;
	nearFullRenderDistance = 5000.0;
	nearDistance = 5000.0;
