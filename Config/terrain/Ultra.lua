distance =
{
	...
	uniqueSceneFarDistance = 25000.0;
	smokesSceneFarDistance = 25000.0;
...
district =
{
	...
	farDistance = 40000.0;
	farFullRenderDistance = 25000.0;
	nearFullRenderDistance = 4000.0;
	nearDistance = 4000.0;
