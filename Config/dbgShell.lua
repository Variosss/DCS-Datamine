--dbg_shell = "weapons.shells.2A46M_125_HE"
...
dbg_shell_v0 		= -1 -- speed m/s (-1 - from weapon database)
dbg_shell_fire_rate = 120	-- 1/min (0 - single shoot)
use_dbg_shell_view = false	-- params dialog
use_target_aim = false	-- target aim cross in the screen center
