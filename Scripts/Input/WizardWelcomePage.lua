...
local function getPanelMain()
	if not panelMain_ then
		local localization = {
			welcome 			= _(
[[Welcome to Controls Wizard!
It will guide you through the process of setup main controlls.
Press Ok to start or Cancel to leave Controls Wizard.
]]),
		}
		local dialog = DialogLoader.spawnDialogFromFile('./Scripts/Input/WizardWelcomePage.dlg', localization)
