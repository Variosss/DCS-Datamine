...
local function addPlaneRoutePoints(airbase_name_start, airbase_name_target, groups, first_descent_pos, coalition)
    ...
    points[1]["psi"] = pointCourseRad(airbase_start_pos,point_2)
...
--groups_mission_id = AirbornGroups(1,country.id.RUSSIA, "Krymsk", "Gelendzhik")
--groups_mission_id = AirbornGroups(1,country.id.RUSSIA, "Kutaisi", "Senaki-Kolkhi")
--groups_mission_id = AirbornGroups_for_test(1,country.id.RUSSIA, nil, "Gelendzhik")
--groups_mission_id = AirbornGroups(1,country.id.RUSSIA, "Tbilisi-Lochini", "Krasnodar-Center")
--groups_mission_id = AirbornGroups(1,country.id.RUSSIA, "Tbilisi-Lochini", "Novorossiysk")
