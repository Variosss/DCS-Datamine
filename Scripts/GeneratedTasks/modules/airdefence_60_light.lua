...
function AirdefenceGroupsPrepare(squad_name, airbase_name, unit_skill)
    ...
    local group_1 = AirdefenceGroupFirst(calc_zones[order_zone[1]].zone, unit_skill)
    local group_2 = AirdefenceGroupSecond(calc_zones[order_zone[2]].zone, unit_skill)
    local group_3 = AirdefenceGroupSupport(calc_zones[order_zone[3]].zone, unit_skill)
